...
var __spreadValues = (a, b2) => {
	for (var prop2 in b2 || (b2 = {}))
		if (__hasOwnProp.call(b2, prop2)) __defNormalProp(a, prop2, b2[prop2]);
...
function _createForOfIteratorHelperLoose(o, allowArrayLike) {
	...
	if (typeof Symbol === 'undefined' || o[Symbol.iterator] == null) {
		if (
			Array.isArray(o) ||
			(it2 = _unsupportedIterableToArray(o)) ||
...
function match$2(value, lookup) {
	...
	if (Error.captureStackTrace) Error.captureStackTrace(error, match$2);
	throw error;
}
var Features;
(function (Features2) {
...
function render$1(_ref) {
	...
	if (featureFlags & Features.Static) {
		var _props$static = props['static'],
			...
			rest = _objectWithoutPropertiesLoose(props, ['static']);
	...
	if (featureFlags & Features.RenderStrategy) {
		...
		return match$2(
			strategy,
			((_match = {}),
			(_match[RenderStrategy.Unmount] = function () {
				return null;
			}),
...
function _render(props, slot, tag, name) {
	...
	var _omit = omit(props, ['unmount', 'static']),
		...
		passThroughProps = _objectWithoutPropertiesLoose(_omit, [
			'as',
			'children',
			'refName',
		]);
	var refRelatedProps =
		props.ref !== void 0
			? ((_ref2 = {}), (_ref2[refName] = props.ref), _ref2)
			: {};
...
function mergeEventFunctions(
	...
	var _loop = function _loop2() {
		...
		if (
			passThroughProps[func] !== void 0 &&
			existingProps[func] !== void 0
		) {
			var _Object$assign;
			Object.assign(
				clone,
				((_Object$assign = {}),
				(_Object$assign[func] = function (event) {
	...
	for (
		var _iterator = _createForOfIteratorHelperLoose(functionsToMerge),
			_step;
...
function forwardRefWithAs(component) {
	...
	return Object.assign(forwardRef(component), {
		displayName:
			(_component$displayNam = component.displayName) != null
				? _component$displayNam
				: component.name,
	});
}
...
function omit(object, keysToOmit) {
	...
	var clone = Object.assign({}, object);
	for (
		var _iterator2 = _createForOfIteratorHelperLoose(keysToOmit), _step2;
...
function useSyncRefs() {
	...
	return useCallback(
		function (value) {
			for (
				var _iterator = _createForOfIteratorHelperLoose(cache.current),
					_step;
				!(_step = _iterator()).done;
...
function isDisabledReactIssue7711(element) {
	...
	var isParentDisabled =
		(_ref =
			((_parent = parent) == null
				? void 0
				: _parent.getAttribute('disabled')) === '') != null
			? _ref
			: false;
...
function isFocusableElement(element, mode) {
	...
	return match$2(
		mode,
		((_match = {}),
		(_match[FocusableMode.Strict] = function () {
...
var reducers =
	((_reducers = {}),
	(_reducers[ActionTypes.TogglePopover] = function (state2) {
		var _match;
		return _extends({}, state2, {
			popoverState: match$2(
				state2.popoverState,
				((_match = {}),
				(_match[PopoverStates.Open] = PopoverStates.Closed),
				(_match[PopoverStates.Closed] = PopoverStates.Open),
				_match)
			),
		});
	}),
	(_reducers[ActionTypes.ClosePopover] = function (state2) {
		if (state2.popoverState === PopoverStates.Closed) return state2;
		return _extends({}, state2, {
			popoverState: PopoverStates.Closed,
		});
	}),
	(_reducers[ActionTypes.SetButton] = function (state2, action) {
		if (state2.button === action.button) return state2;
		return _extends({}, state2, {
			button: action.button,
		});
	}),
	(_reducers[ActionTypes.SetButtonId] = function (state2, action) {
		if (state2.buttonId === action.buttonId) return state2;
		return _extends({}, state2, {
			buttonId: action.buttonId,
		});
	}),
	(_reducers[ActionTypes.SetPanel] = function (state2, action) {
		if (state2.panel === action.panel) return state2;
		return _extends({}, state2, {
			panel: action.panel,
		});
	}),
	(_reducers[ActionTypes.SetPanelId] = function (state2, action) {
		if (state2.panelId === action.panelId) return state2;
		return _extends({}, state2, {
...
function Popover(props) {
	...
	var registerPopover =
		groupContext == null ? void 0 : groupContext.registerPopover;
	var isFocusWithinPopoverGroup = useCallback(
		function () {
			var _groupContext$isFocus;
			return (_groupContext$isFocus =
				groupContext == null
					? void 0
					: groupContext.isFocusWithinPopoverGroup()) != null
				? _groupContext$isFocus
				: (button == null
						? void 0
	...
	useWindowEvent('mousedown', function (event) {
		...
		if (popoverState !== PopoverStates.Open) return;
		if (button == null ? void 0 : button.contains(target2)) return;
		if (panel == null ? void 0 : panel.contains(target2)) return;
		dispatch({
			type: ActionTypes.ClosePopover,
		});
			...
			React.createElement(
				OpenClosedProvider,
				{
					value: match$2(
						popoverState,
						((_match2 = {}),
						(_match2[PopoverStates.Open] = State.Open),
						(_match2[PopoverStates.Closed] = State.Closed),
						_match2)
					),
				},
				render$1({
...
var Button = /* @__PURE__ */ forwardRefWithAs(function Button2(props, ref) {
	var _usePopoverContext = usePopoverContext(
			[Popover.name, Button2.name].join('.')
		),
		state2 = _usePopoverContext[0],
	...
	var isWithinPanel =
		panelContext === null ? false : panelContext === state2.panelId;
	var buttonRef = useSyncRefs(
		internalButtonRef,
		ref,
		isWithinPanel
			? null
	...
	var previousActiveElementRef = useRef(
	...
	var handleKeyDown = useCallback(
		function (event) {
			var _state$button;
			if (isWithinPanel) {
				if (state2.popoverState === PopoverStates.Closed) return;
				switch (event.key) {
					case Keys.Space:
					case Keys.Enter:
						event.preventDefault();
						...
						(_state$button = state2.button) == null
							? void 0
							: _state$button.focus();
						break;
				}
				...
				switch (event.key) {
					...
					case Keys.Escape:
						if (state2.popoverState !== PopoverStates.Open)
							return closeOthers == null
								? void 0
								: closeOthers(state2.buttonId);
						if (!internalButtonRef.current) return;
						if (
							!internalButtonRef.current.contains(
						...
						break;
					case Keys.Tab:
						if (state2.popoverState !== PopoverStates.Open) return;
						if (!state2.panel) return;
						if (!state2.button) return;
						if (event.shiftKey) {
							var _state$button2;
							if (!previousActiveElementRef.current) return;
							if (
								(_state$button2 = state2.button) == null
									? void 0
									: _state$button2.contains(
											previousActiveElementRef.current
									  )
							)
								return;
							if (
								state2.panel.contains(
									previousActiveElementRef.current
								)
							)
								return;
							var focusableElements = getFocusableElements();
							var previousIdx = focusableElements.indexOf(
								previousActiveElementRef.current
							);
							var buttonIdx = focusableElements.indexOf(
								state2.button
							);
		...
		function (event) {
			...
			switch (event.key) {
				case Keys.Tab:
					if (!previousActiveElementRef.current) return;
					if (
						(_state$button3 = state2.button) == null
							? void 0
							: _state$button3.contains(
									previousActiveElementRef.current
							  )
					)
						return;
	...
	var handleClick = useCallback(
		function (event) {
			...
			if (isWithinPanel) {
				...
				(_state$button4 = state2.button) == null
					? void 0
					: _state$button4.focus();
			} else {
				var _state$button5;
				if (state2.popoverState === PopoverStates.Closed)
					closeOthers == null ? void 0 : closeOthers(state2.buttonId);
				(_state$button5 = state2.button) == null
					? void 0
					: _state$button5.focus();
				dispatch({
					type: ActionTypes.TogglePopover,
				});
			}
	...
	var propsWeControl = isWithinPanel
		...
		: {
				...
				'aria-expanded': props.disabled
					? void 0
					: state2.popoverState === PopoverStates.Open,
...
var Overlay = /* @__PURE__ */ forwardRefWithAs(function Overlay2(props, ref) {
	var _usePopoverContext2 = usePopoverContext(
			[Popover.name, Overlay2.name].join('.')
		),
...
var Panel = /* @__PURE__ */ forwardRefWithAs(function Panel2(props, ref) {
	...
	var _usePopoverContext3 = usePopoverContext(
			[Popover.name, Panel2.name].join('.')
		),
		state2 = _usePopoverContext3[0],
		dispatch = _usePopoverContext3[1];
	var _usePopoverAPIContext = usePopoverAPIContext(
			[Popover.name, Panel2.name].join('.')
		),
		...
		function (event) {
			...
			switch (event.key) {
				case Keys.Escape:
					...
					if (
						!internalPanelRef.current.contains(
							document.activeElement
						)
					)
						return;
					...
					(_state$button6 = state2.button) == null
						? void 0
						: _state$button6.focus();
					break;
			}
		},
	...
	useEffect(
		function () {
			var _props$unmount;
			if (
				state2.popoverState === PopoverStates.Closed &&
				((_props$unmount = props.unmount) != null
					? _props$unmount
					: true)
			) {
				dispatch({
	...
	useEffect(
		function () {
			...
			if (internalPanelRef.current.contains(activeElement)) return;
	...
	useWindowEvent('keydown', function (event) {
		...
		if (result === FocusResult.Underflow) {
			var _state$button7;
			return (_state$button7 = state2.button) == null
				? void 0
				: _state$button7.focus();
			...
			var nextElements = elements
				...
				.filter(function (element) {
					...
					return !((_internalPanelRef$cur =
						internalPanelRef.current) == null
						? void 0
						: _internalPanelRef$cur.contains(element));
				});
	...
	useWindowEvent(
		...
		function () {
			...
			if (!internalPanelRef.current) return;
			if (
				(_internalPanelRef$cur2 = internalPanelRef.current) == null
					? void 0
					: _internalPanelRef$cur2.contains(document.activeElement)
			)
				return;
			dispatch({
				type: ActionTypes.ClosePopover,
...
function Group(props) {
	...
	var unregisterPopover = useCallback(
	...
	var registerPopover = useCallback(
		function (registerbag) {
			setPopovers(function (existing) {
	...
	var isFocusWithinPopoverGroup = useCallback(
		function () {
			...
			if (
				(_groupRef$current = groupRef.current) == null
					? void 0
					: _groupRef$current.contains(element)
			)
				return true;
			return popovers.some(function (bag) {
				...
				return (
					((_document$getElementB = document.getElementById(
						...
						? void 0
						: _document$getElementB.contains(element)) ||
					((_document$getElementB2 = document.getElementById(
						bag.panelId
					)) == null
						? void 0
						: _document$getElementB2.contains(element))
				);
			});
		},
		[groupRef, popovers]
	);
	var closeOthers = useCallback(
		function (buttonId) {
			for (
				var _iterator = _createForOfIteratorHelperLoose(popovers),
					_step;
				!(_step = _iterator()).done;
...
function addClasses(node2) {
	...
	node2 &&
		classes.length > 0 &&
		(_node$classList = node2.classList).add.apply(_node$classList, classes);
}
function removeClasses(node2) {
	var _node$classList2;
	for (
		var _len2 = arguments.length,
			classes = new Array(_len2 > 1 ? _len2 - 1 : 0),
			_key2 = 1;
		_key2 < _len2;
		_key2++
	) {
	...
	node2 &&
		classes.length > 0 &&
		(_node$classList2 = node2.classList).remove.apply(
			_node$classList2,
			classes
		);
}
...
function waitForTransition(node2, done) {
	var d2 = disposables();
	if (!node2) return d2.dispose;
	var _getComputedStyle = getComputedStyle(node2),
		transitionDuration = _getComputedStyle.transitionDuration,
		transitionDelay = _getComputedStyle.transitionDelay;
	var _map = [transitionDuration, transitionDelay].map(function (value) {
			var _value$split$filter$m = value
					.split(',')
					.filter(Boolean)
					.map(function (v2) {
						return v2.includes('ms')
							? parseFloat(v2)
							: parseFloat(v2) * 1e3;
					})
					.sort(function (a, z2) {
				...
				resolvedValue =
					_value$split$filter$m2 === void 0
						? 0
						: _value$split$filter$m2;
...
function transition(node2, base, from, to, entered, done) {
	...
	d2.nextFrame(function () {
		...
		d2.add(
			waitForTransition(node2, function (reason) {
	...
	d2.add(function () {
		return removeClasses.apply(
			void 0,
			[node2].concat(base, from, to, entered)
		);
	});
	d2.add(function () {
...
function hasChildren$1(bag) {
	if ('children' in bag) return hasChildren$1(bag.children);
	return (
		bag.current.filter(function (_ref) {
...
function useNesting(done) {
	...
	var unregister = useCallback(
		function (childId, strategy) {
			var _match;
			if (strategy === void 0) {
				strategy = RenderStrategy.Hidden;
			}
			var idx = transitionableChildren.current.findIndex(function (
				_ref2
			) {
				var id2 = _ref2.id;
				return id2 === childId;
			...
			match$2(
				...
				(_match[RenderStrategy.Hidden] = function () {
					transitionableChildren.current[idx].state =
						TreeStates.Hidden;
				}),
				_match)
			);
...
function ensureEventHooksExist(events) {
	var result = {};
	for (
		var _iterator = _createForOfIteratorHelperLoose(eventNames), _step;
		!(_step = _iterator()).done;
		...
		result[name] =
			(_events$name = events[name]) != null ? _events$name : noop;
	}
	return result;
}
	...
	useIsoMorphicEffect(
		function () {
			...
			match$2(
				state2,
				((_match2 = {}),
				(_match2[TreeStates.Hidden] = function () {
		...
		React.createElement(
			OpenClosedProvider,
			{
				value: match$2(
					state2,
					((_match3 = {}),
					(_match3[TreeStates.Visible] = State.Open),
					(_match3[TreeStates.Hidden] = State.Closed),
					_match3)
				),
			},
			render$1({
...
function Transition(props) {
	var show = props.show,
		...
		passthroughProps = _objectWithoutPropertiesLoose(props, [
			'show',
			'appear',
			'unmount',
		]);
	...
	if (show === void 0 && usesOpenClosedState !== null) {
		...
		show = match$2(
			usesOpenClosedState,
			((_match4 = {}),
			(_match4[State.Open] = true),
			(_match4[State.Closed] = false),
			_match4)
		);
	}
			...
			render$1({
				props: _extends({}, sharedProps, {
					...
					children: React.createElement(
						TransitionChild,
						Object.assign({}, sharedProps, passthroughProps)
					),
				}),
				defaultTag: Fragment,
				features: TransitionChildRenderFeatures,
...
Transition.Child = function Child(props) {
	...
	return !hasTransitionContext && hasOpenClosedContext
		? React.createElement(Transition, Object.assign({}, props))
		: React.createElement(TransitionChild, Object.assign({}, props));
};
...
function buildLocalizeFn(args) {
	return function (dirtyIndex, dirtyOptions) {
		...
		var index2 = args.argumentCallback
...
var Text = (function (_super) {
	...
	function Text2(data) {
		return (
			_super.call(this, domelementtype_1$1.ElementType.Text, data) || this
		);
	}
	return Text2;
})(DataNode);
...
var Comment = (function (_super) {
	...
	function Comment2(data) {
		return (
			_super.call(this, domelementtype_1$1.ElementType.Comment, data) ||
			this
		);
	}
	return Comment2;
...
var ProcessingInstruction = (function (_super) {
	...
	function ProcessingInstruction2(name, data) {
		var _this =
			_super.call(this, domelementtype_1$1.ElementType.Directive, data) ||
			this;
		_this.name = name;
		return _this;
	}
...
var Document = (function (_super) {
	...
	function Document2(children) {
		return (
			_super.call(this, domelementtype_1$1.ElementType.Root, children) ||
			this
		);
	}
	return Document2;
...
(function (exports) {
	...
	var DomHandler = (function () {
		...
		DomHandler2.prototype.ontext = function (data) {
			...
			if (
				lastNode &&
				lastNode.type === domelementtype_12.ElementType.Text
			) {
	...
	(function (root, factory) {
				...
				if (state2.isComplete) {
					...
					if (state2.data !== Parser2.fail) {
						...
						if (state2.reference === this.index) {
							...
							(this.completed[exp] =
								this.completed[exp] || []).push(state2);
						}
					}
				} else {
		...
		Parser2.prototype.feed = function (chunk) {
			...
			while (true) {
				...
				var value =
					lexer2.constructor === StreamLexer ? token.value : token;
	...
	(function (root, factory) {
		...
		function objectToRules(object) {
			...
			for (var i = 0; i < keys.length; i++) {
				...
				if (match2.length) result.push(ruleOptions(key, match2));
			}
			return result;
		}
		...
		function ruleOptions(type, obj) {
			...
			options.match = Array.isArray(match2)
				? match2
				: match2
				? [match2]
				: [];
			options.match.sort(function (a, b2) {
				return isRegExp(a) && isRegExp(b2)
					? 0
					: isRegExp(b2)
					? -1
					: isRegExp(a)
		...
		Lexer.prototype.next = function () {
			...
			if (match2 == null) {
				return this._token(
					error,
					buffer.slice(index2, buffer.length),
					index2
				);
			}
			...
			if (error.fallback && match2.index !== index2) {
				...
				return this._token(
					error,
					buffer.slice(index2, match2.index),
					index2
				);
			}
...
const grammar = {
	...
	ParserRules: [
		...
		},
		{
			name: 'attrValue',
			symbols: ['str'],
			postprocess: ([v2]) => ({ value: v2, modifier: null }),
		},
		{
			name: 'attrValue',
			symbols: ['idn'],
		...
		},
		{
			...
			postprocess: ([v2, , mod]) => ({ value: v2, modifier: mod }),
		},
		{
			name: 'attrValue',
		...
		},
		{
			name: 'idSelector',
			symbols: [
				lexer.has('hashToken') ? { type: 'hashToken' } : hashToken,
			],
		...
		},
		{
			name: 'wqname',
			symbols: ['idn'],
			postprocess: ([name]) => ({ name, namespace: null }),
		},
		{
			name: 'wqname',
			symbols: ['ns', 'idn'],
			postprocess: ([ns, name]) => ({ name, namespace: ns }),
		},
		{
			name: 'ns',
...
const compiledRulesNoList = __spreadProps(__spreadValues({}, grammar), {
...
function normalize(selector) {
	...
	switch (selector.type) {
		case 'compound': {
			...
			selector.list.sort((a, b2) =>
				_compareArrays(
					_getSelectorPriority(a),
					_getSelectorPriority(b2)
				)
			);
			break;
		}
...
${treeifyArray(node2.cont)}`;
		case 'matcher':
			return `\u25C8 ${node2.matcher} "${node2.value}"${
				node2.modifier || ''
			}
${treeifyArray(node2.cont)}`;
	}
	...
	for (const item of items) {
		...
		if (simpsels.length) {
			const isMatch = simpsels.some(
				(node2) => getSelectorKind(node2) === selectedKind
			);
...
function attrPresenceBranch(name, items) {
	for (const item of items) {
		spliceSimpleSelector(
			item,
			(x2) => x2.type === 'attrPresence' && x2.name === name
		);
	}
	return {
		type: 'attrPresence',
...
function attrValueBranch(name, items) {
	const groups = spliceAndGroup(
		items,
		(x2) => x2.type === 'attrValue' && x2.name === name,
		(x2) => `${x2.matcher} ${x2.modifier || ''} ${x2.value}`
	);
	const matchers = [];
...
function combinatorBranch(combinator, items) {
	const groups = spliceAndGroup(
		items,
		(x2) => x2.type === 'combinator' && x2.combinator === combinator,
		(x2) => parseley__namespace.serialize(x2.left)
	);
	const leftItems = [];
	for (const group of Object.values(groups)) {
...
function handleAttrPresenceName(node2) {
	...
	return (el2, ...tail) =>
		Object.prototype.hasOwnProperty.call(el2.attribs, attrName)
			? continuation(el2, ...tail)
			: [];
}
function handleAttrValueName(node2) {
	...
	for (const matcher of node2.matchers) {
		...
		callbacks.push((attr, el2, ...tail) =>
			predicate(attr) ? continuation(el2, ...tail) : []
		);
	}
	const attrName = node2.name;
	return (el2, ...tail) => {
		...
		return attr || attr === ''
			? flatMap(callbacks, (cb) => cb(attr, el2, ...tail))
			: [];
	};
}
function handlePushElementNode(node2) {
	...
	const leftElementGetter =
		node2.combinator === '+' ? getPrecedingElement : getParentElement;
	return (el2, ...tail) => {
...
function getEnumerableOwnPropertySymbols(target2) {
	return Object.getOwnPropertySymbols
		? Object.getOwnPropertySymbols(target2).filter(function (symbol) {
				return target2.propertyIsEnumerable(symbol);
		  })
		: [];
}
function getKeys(target2) {
	return Object.keys(target2).concat(
		getEnumerableOwnPropertySymbols(target2)
	);
}
...
function propertyIsUnsafe(target2, key) {
	return (
		propertyIsOnObject(target2, key) &&
		!(
			Object.hasOwnProperty.call(target2, key) &&
			Object.propertyIsEnumerable.call(target2, key)
		)
	);
}
...
var Tokenizer = (function () {
	...
	Tokenizer2.prototype.stateAfterSpecialLast = function (
		c,
		sectionStartOffset
	) {
		if (c === '>' || whitespace(c)) {
	...
	Tokenizer2.prototype.parseFixedEntity = function (map2) {
		if (map2 === void 0) {
			map2 = this.xmlMode
				? xml_json_1$2.default
				: entities_json_1$2.default;
		}
		...
		if (
			...
			while (
				...
				openImpliesClose[name].has(
					(el2 = this.stack[this.stack.length - 1])
				)
			) {
				this.onclosetag(el2);
			}
	...
	function (mod) {
		...
		if (mod != null) {
			for (var k2 in mod)
				if (
					k2 !== 'default' &&
					Object.prototype.hasOwnProperty.call(mod, k2)
				)
...
function getInnerHTML(node2, options) {
	return (0, domhandler_1$5.hasChildren)(node2)
		? node2.children
				.map(function (node3) {
...
function getText$1(node2) {
	...
	if ((0, domhandler_1$5.isCDATA)(node2)) return getText$1(node2.children);
	if ((0, domhandler_1$5.isText)(node2)) return node2.data;
	return '';
}
...
function textContent(node2) {
	...
	if (
		(0, domhandler_1$5.hasChildren)(node2) &&
		!(0, domhandler_1$5.isComment)(node2)
	) {
...
function innerText(node2) {
	...
	if (
		...
		(node2.type === domelementtype_1.ElementType.Tag ||
			(0, domhandler_1$5.isCDATA)(node2))
	) {
...
function find(test, nodes, recurse, limit) {
	...
	for (var _i = 0, nodes_1 = nodes; _i < nodes_1.length; _i++) {
		...
		if (
			recurse &&
			(0, domhandler_1$3.hasChildren)(elem) &&
			elem.children.length > 0
		) {
...
function existsOne(test, nodes) {
	return nodes.some(function (checked) {
		return (
			(0, domhandler_1$3.isTag)(checked) &&
			(test(checked) ||
	...
	while ((elem = stack.shift())) {
		var children =
			(_a = elem.children) === null || _a === void 0
				? void 0
				: _a.filter(domhandler_1$3.isTag);
...
function getAttribCheck(attrib, value) {
	if (typeof value === 'function') {
		return function (elem) {
			return (
				(0, domhandler_1$2.isTag)(elem) && value(elem.attribs[attrib])
			);
		};
	}
	return function (elem) {
		return (
			(0, domhandler_1$2.isTag)(elem) && elem.attribs[attrib] === value
		);
	};
}
	...
	var feed = {
		...
		items: (0, legacy_1.getElementsByTagName)('entry', childs).map(
			function (item) {
				...
				var href2 =
					(_a2 = getOneElement$1('link', children)) === null ||
					_a2 === void 0
						? void 0
						: _a2.attribs.href;
				if (href2) {
				...
				var description =
					fetch$2('summary', children) ||
					fetch$2('content', children);
				if (description) {
...
(function (FeedItemMediaMedium2) {
	...
	FeedItemMediaMedium2[(FeedItemMediaMedium2['executable'] = 4)] =
		'executable';
})(FeedItemMediaMedium || (FeedItemMediaMedium = {}));
var FeedItemMediaExpression;
(function (FeedItemMediaExpression2) {
	FeedItemMediaExpression2[(FeedItemMediaExpression2['sample'] = 0)] =
		'sample';
	FeedItemMediaExpression2[(FeedItemMediaExpression2['full'] = 1)] = 'full';
	FeedItemMediaExpression2[(FeedItemMediaExpression2['nonstop'] = 2)] =
		'nonstop';
...
function numberToRoman$1(num2) {
	return [...(num2 + '')]
		...
		.map((v2, i) =>
			v2 % 5 < 4
				? (v2 < 5 ? '' : V$1[i]) + I$1[i].repeat(v2 % 5)
				: I$1[i] + (v2 < 5 ? V$1[i] : I$1[i + 1])
		)
		.reverse()
		.join('');
}
...
function mergeDuplicatesPreferLast$1(items, getKey) {
	...
	for (let i = items.length; i-- > 0; ) {
		...
		map2.set(
			key,
			map2.has(key)
				? merge$1(item, map2.get(key), { arrayMerge: overwriteMerge$1 })
				: item
		);
	}
			...
			if (!cell.rendered) {
				...
				for (let j2 = 0; j2 < cell.lines.length; j2++) {
					...
					outputLines[lineOffset] =
						(outputLines[lineOffset] || '').padEnd(colOffsets[x2]) +
						line;
					cellWidth =
						line.length > cellWidth ? line.length : cellWidth;
				}
				updateOffset(
					colOffsets,
					x2,
					cell.colspan,
					cellWidth + colSpacing
				);
				cell.rendered = true;
			}
			y2 += cell.rowspan;
...
${whitespaceCodes}]+`,
			...
			this.shrinkWrapAdd = function (
				...
				inlineTextBuilder2.stashedSpace =
...
class BlockTextBuilder$1 {
	...
	_addInline(str, { noWordTransform = false } = {}) {
		...
		if (
			this.whitepaceProcessor.testContainsWords(str) ||
	...
	_closeBlock({ trailingLineBreaks = 1, blockTransform = void 0 } = {}) {
		...
		const blockText = blockTransform
			? blockTransform(getText(block2))
			: getText(block2);
		addText(
			this._stackItem,
			blockText,
			block2.leadingLineBreaks,
			Math.max(block2.stashedLineBreaks, trailingLineBreaks)
		);
	}
	openTable() {
	...
	closeTable(
		...
		rowSpacing = void 0,
		leadingLineBreaks = void 0,
		trailingLineBreaks = void 0
	) {
...
function getText(stackItem2) {
	if (
		!(
			stackItem2 instanceof BlockStackItem ||
			stackItem2 instanceof TableCellStackItem
		)
	) {
		throw new Error(
	...
	return stackItem2.inlineTextBuilder.isEmpty()
		? stackItem2.rawText
		: stackItem2.rawText + stackItem2.inlineTextBuilder.toString();
}
...
function formatAnchor(elem, walk, builder, formatOptions) {
	function getHref() {
		...
		href2 =
			formatOptions.baseUrl && href2[0] === '/'
				? formatOptions.baseUrl + href2
				: href2;
...
function isDataTable(attr, tables) {
	...
	return (
		attrClasses.some((x2) => classes.includes(x2)) ||
		attrIds.some((x2) => ids.includes(x2))
	);
}
	...
	if (selectorsWithoutFormat.length) {
		throw new Error(
			'Following selectors have no specified format: ' +
				selectorsWithoutFormat
					.map((s2) => `\`${s2.selector}\``)
					.join(', ')
		);
	}
	const picker = new selderee.DecisionTree(
		uniqueSelectors.map((s2) => [s2.selector, s2])
	).build(hp2Builder);
							...
							t &&
								(i =
									2 & u3[0]
										...
										: u3[0]
										? t.throw ||
										  ((i = t.return) && i.call(t), 0)
										: t.next) &&
								!(i = i.call(t, u3[1])).done)
						)
							return i;
						switch (
							((t = 0), i && (u3 = [2 & u3[0], i.value]), u3[0])
						) {
							case 0:
							case 1:
								i = u3;
...
var d = {}[0],
	...
	m = (b && window.addEventListener) || g,
	O = (w && document.addEventListener) || g,
	V = {
		isOnline: function () {
			return y;
		},
	...
	T = typeof window == 'undefined' || 'Deno' in window,
	...
	E = T ? useEffect : useLayoutEffect,
	I = typeof navigator != 'undefined' && navigator.connection,
	x = !T && I && (['slow-2g', '2g'].includes(I.effectiveType) || I.saveData),
	P = new WeakMap(),
	F = 0;
function M(e) {
	if (h(e))
...
var W = new WeakMap(),
	$ = function (e, r, n, t, i, u) {
		...
		var o = W.get(e),
			...
			f = a[r],
			l2 = c[r];
		if (l2) for (var s2 = 0; s2 < l2.length; ++s2) l2[s2](n, t, i);
		return u && f && f[0]
			? f[0](2).then(function () {
					return e.get(r);
			  })
...
function j(e, r) {
	if (!W.has(e)) {
		...
		return (
			W.set(e, [t, {}, {}, {}, {}, {}, i]),
			T ||
				(n.initFocus(L.bind(d, t, 0)),
				n.initReconnect(L.bind(d, t, 1))),
			[e, i]
		);
	}
}
	...
	J = p(
		{
			...
			onSuccess: g,
			onError: g,
			onErrorRetry: function (e, r, n, t, i) {
				if (V.isVisible()) {
					var u = n.errorRetryCount,
						o = i.retryCount,
						a =
...
Object.defineProperty(
	function (e) {
		...
		return (
			...
			createElement(z.Provider, { value: o }, r)
		);
	},
	'default',
	{ value: J }
...
var Z =
	((K = function (e, r, n) {
		var t = n.cache,
			...
			f = n.fallbackData,
			h2 = n.suspense,
			g2 = n.revalidateOnMount,
			y2 = n.refreshInterval,
			b2 = n.refreshWhenHidden,
			w2 = n.refreshWhenOffline,
			m2 = W.get(t),
			O2 = m2[0],
			V2 = m2[1],
			k2 = m2[2],
		...
		var Y = function () {
				return v(g2)
					? h2
						? !A2.current && !v(K2)
						: v(K2) || n.revalidateIfStale
					: g2;
			},
			Z2 = !(!F2 || !r) && (!!t.get(j2) || (!A2.current && Y())),
			_ = (function (e2, r2) {
				var n2 = useState({})[1],
					t2 = useRef(e2),
					u2 = useRef({
			...
			})({ data: K2, error: X, isValidating: Z2 }, G2),
			ee2 = _[0],
			re = _[1],
			ne2 = _[2],
			te = useCallback(
							...
							switch (s2.label) {
									...
									return (
										n.loadingTimeout &&
											...
											setTimeout(function () {
												a &&
													l2() &&
													N2().onLoadingSlow(F2, n);
											}, n.loadingTimeout),
										(x2[F2] = o = C()),
										[4, (I2[F2] = r.apply(r, q2))]
									);
								case 4:
									(i = s2.sent()),
										setTimeout(function () {
								...
								case 6:
									return (
										...
										t.set(j2, false),
										N2().isPaused()
											? (ne2({ isValidating: false }),
											  [2, false])
											: (t.set(L2, p2),
											  ee2.current.error !== p2 &&
													(ne2({
														isValidating: false,
														error: p2,
													}),
				...
				function () {
					if (F2) {
						var e2 = A2.current,
							...
							t2 = 0,
							i = Q(F2, V2, function (e3, r3, n3) {
								ne2(
									p(
										{ error: r3, isValidating: n3 },
										u(e3, ee2.current.data)
											? null
											: { data: e3 }
									)
								);
							...
							o = Q(F2, O2, function (e3) {
								if (e3 === 0) {
									var i2 = Date.now();
									N2().revalidateOnFocus &&
										i2 > t2 &&
										n2() &&
										((t2 = i2 + N2().focusThrottleInterval),
										r2());
								} else if (e3 === 1)
									N2().revalidateOnReconnect && n2() && r2();
								else if (e3 === 2) return te();
							});
						return (
							(G2.current = false),
							(H2.current = F2),
							e2 && ne2({ data: K2, error: X, isValidating: Z2 }),
							Y() && (v(K2) || T ? r2() : S(r2)),
							(A2.current = true),
							function () {
								(G2.current = true), i(), o();
	...
	function () {
		...
		var n = B(e),
			...
			f = K,
			l2 = c.use;
		if (l2) for (var s2 = l2.length; s2-- > 0; ) f = l2[s2](f);
...
function Herald(props) {
	const { feed, isLoading } = useChangelogFeed(
		props == null ? void 0 : props.baseUrl,
		props == null ? void 0 : props.userId
	);
