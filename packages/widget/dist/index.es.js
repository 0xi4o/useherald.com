...
function N(e) {
	var t = e.props,
		...
		o = void 0 === i || i,
		s = e.name;
	if (o) return P(t, r, n, s);
	var l = null != a ? a : q.None;
	if (l & q.Static) {
		var c = t.static,
			u = void 0 !== c && c,
			p = C(t, ['static']);
		if (u) return P(p, r, n, s);
	}
	if (l & q.RenderStrategy) {
		var d,
			f = t.unmount,
			h = void 0 === f || f,
			m = C(t, ['unmount']);
		return O(
			h ? T.Unmount : T.Hidden,
			(((d = {})[T.Unmount] = function () {
				return null;
			}),
			(d[T.Hidden] = function () {
				return P(
					L({}, m, { hidden: !0, style: { display: 'none' } }),
					r,
					n,
					s
				);
...
function P(e, t, r, n) {
	var a;
	void 0 === t && (t = {});
	var i = R(e, ['unmount', 'static']),
		o = i.as,
		s = void 0 === o ? r : o,
		l = i.children,
		c = i.refName,
		h = void 0 === c ? 'ref' : c,
		m = C(i, ['as', 'children', 'refName']),
		g = void 0 !== e.ref ? (((a = {})[h] = e.ref), a) : {},
		b = 'function' == typeof l ? l(t) : l;
	if (
		(m.className &&
			'function' == typeof m.className &&
			(m.className = m.className(t)),
		s === u && Object.keys(m).length > 0)
	) {
		if (!p(b) || (Array.isArray(b) && b.length > 1))
			throw new Error(
				[
							...
							i = function () {
								...
								void 0 !== e[i] &&
									...
									Object.assign(
										a,
										(((r = {})[i] = function (r) {
											r.defaultPrevented || e[i](r),
												r.defaultPrevented || t[i](r);
										}),
										r)
									);
							},
	...
	return f(s, Object.assign({}, R(m, ['ref']), s !== u && g), b);
}
function I(e) {
	var t;
...
function R(e, t) {
	void 0 === t && (t = []);
	for (var r, n = Object.assign({}, e), a = B(t); !(r = a()).done; ) {
		var i = r.value;
		i in n && delete n[i];
	}
	return n;
...
((D = q || (q = {}))[(D.None = 0)] = 'None'),
	(D[(D.RenderStrategy = 1)] = 'RenderStrategy'),
	(D[(D.Static = 2)] = 'Static'),
	((A = T || (T = {}))[(A.Unmount = 0)] = 'Unmount'),
	(A[(A.Hidden = 1)] = 'Hidden');
var j = 'undefined' != typeof window ? m : g,
	M = { serverHandoffComplete: !1 };
function F() {
	var e = b(M.serverHandoffComplete),
		t = e[0],
		r = e[1];
	return (
		g(
...
function G() {
	...
	return (
		...
		v(
			function (e) {
				for (var t, r = B(n.current); !(t = r()).done; ) {
					var a = t.value;
					null != a &&
...
function W(e) {
	...
	var i =
		null !=
			(t =
				'' ===
				(null == (r = n) ? void 0 : r.getAttribute('disabled'))) && t;
	return (
		(!i ||
			!(function (e) {
				if (!e) return !1;
...
((V = U || (U = {})).Space = ' '),
	...
	(V.ArrowLeft = 'ArrowLeft'),
	(V.ArrowUp = 'ArrowUp'),
	(V.ArrowRight = 'ArrowRight'),
	(V.ArrowDown = 'ArrowDown'),
	(V.Home = 'Home'),
	(V.End = 'End'),
	(V.PageUp = 'PageUp'),
	(V.PageDown = 'PageDown'),
...
function ie(e) {
	return (
		...
		null == e ? [] : Array.from(e.querySelectorAll(ae))
	);
}
function oe(e, t) {
	var r = Array.isArray(e) ? e : ie(e),
		n = document.activeElement,
		a = (function () {
			if (t & (X.First | X.Next)) return ee.Next;
			if (t & (X.Previous | X.Last)) return ee.Previous;
			throw new Error(
				'Missing Focus.First, Focus.Previous, Focus.Next or Focus.Last'
			);
		})(),
		i = (function () {
			if (t & X.First) return 0;
			if (t & X.Previous) return Math.max(0, r.indexOf(n)) - 1;
			if (t & X.Next) return Math.max(0, r.indexOf(n)) + 1;
			if (t & X.Last) return r.length - 1;
			throw new Error(
				'Missing Focus.First, Focus.Previous, Focus.Next or Focus.Last'
			);
		})(),
		o = t & X.NoScroll ? { preventScroll: !0 } : {},
		s = 0,
		l = r.length,
		c = void 0;
	do {
		var u;
		if (s >= l || s + l <= 0) return Q.Error;
		var p = i + s;
		if (t & X.WrapAround) p = (p + l) % l;
		else {
			if (p < 0) return Q.Underflow;
			if (p >= l) return Q.Overflow;
		}
		null == (u = c = r[p]) || u.focus(o), (s += a);
	} while (c !== document.activeElement);
	return (
		c.hasAttribute('tabindex') || c.setAttribute('tabindex', '0'), Q.Success
	);
}
((Z = X || (X = {}))[(Z.First = 1)] = 'First'),
	(Z[(Z.Previous = 2)] = 'Previous'),
	(Z[(Z.Next = 4)] = 'Next'),
	(Z[(Z.Last = 8)] = 'Last'),
	(Z[(Z.WrapAround = 16)] = 'WrapAround'),
	(Z[(Z.NoScroll = 32)] = 'NoScroll'),
	((K = Q || (Q = {}))[(K.Error = 0)] = 'Error'),
	(K[(K.Overflow = 1)] = 'Overflow'),
	(K[(K.Success = 2)] = 'Success'),
	(K[(K.Underflow = 3)] = 'Underflow'),
	((te = ee || (ee = {}))[(te.Previous = -1)] = 'Previous'),
	(te[(te.Next = 1)] = 'Next'),
	((ne = re || (re = {}))[(ne.Strict = 0)] = 'Strict'),
	(ne[(ne.Loose = 1)] = 'Loose');
var se,
	le,
	ce,
...
function ge(e) {
	var t = e.value,
		r = e.children;
	return c.createElement(he.Provider, { value: t }, r);
}
function be(e) {
	var t;
...
function ve() {
	var e = [],
		t = {
			...
			dispose: function () {
				for (var t, r = B(e.splice(0)); !(t = r()).done; ) {
					(0, t.value)();
				}
			},
		};
...
(he.displayName = 'OpenClosedContext'),
	((le = se || (se = {}))[(le.Open = 0)] = 'Open'),
	(le[(le.Closed = 1)] = 'Closed'),
	((pe = ue || (ue = {}))[(pe.Open = 0)] = 'Open'),
	(pe[(pe.Closed = 1)] = 'Closed'),
	((fe = de || (de = {}))[(fe.TogglePopover = 0)] = 'TogglePopover'),
	(fe[(fe.ClosePopover = 1)] = 'ClosePopover'),
	(fe[(fe.SetButton = 2)] = 'SetButton'),
	(fe[(fe.SetButtonId = 3)] = 'SetButtonId'),
	(fe[(fe.SetPanel = 4)] = 'SetPanel'),
	(fe[(fe.SetPanelId = 5)] = 'SetPanelId');
var ye =
		(((ce = {})[de.TogglePopover] = function (e) {
			var t;
			return L({}, e, {
				popoverState: O(
					e.popoverState,
		...
		(ce[de.ClosePopover] = function (e) {
			return e.popoverState === ue.Closed
				? e
				: L({}, e, { popoverState: ue.Closed });
		}),
		(ce[de.SetButton] = function (e, t) {
			return e.button === t.button ? e : L({}, e, { button: t.button });
		}),
		(ce[de.SetButtonId] = function (e, t) {
			return e.buttonId === t.buttonId
				? e
				: L({}, e, { buttonId: t.buttonId });
		}),
		(ce[de.SetPanel] = function (e, t) {
			return e.panel === t.panel ? e : L({}, e, { panel: t.panel });
		}),
		(ce[de.SetPanelId] = function (e, t) {
...
function xe(e) {
	...
	if (null === t) {
		var r = new Error(
			'<' + e + ' /> is missing a parent <' + Ae.name + ' /> component.'
		);
		throw (Error.captureStackTrace && Error.captureStackTrace(r, xe), r);
	}
	return t;
}
we.displayName = 'PopoverContext';
var ke = x(null);
function Se(e) {
	var t = w(ke);
	if (null === t) {
...
ke.displayName = 'PopoverAPIContext';
var Ee = x(null);
function qe() {
	return w(Ee);
}
...
var De = x(null);
function Te(e, t) {
	return O(t.type, ye, e, t);
}
De.displayName = 'PopoverPanelContext';
function Ae(e) {
	var t,
		r = 'headlessui-popover-button-' + J(),
		n = 'headlessui-popover-panel-' + J(),
		a = k(Te, {
			popoverState: ue.Closed,
			button: null,
			buttonId: r,
			panel: null,
			panelId: n,
	...
	g(
		function () {
			return u({ type: de.SetButtonId, buttonId: r });
		},
		[r, u]
	),
		g(
			function () {
				return u({ type: de.SetPanelId, panelId: n });
			},
			[n, u]
		);
	var p = S(
	...
	g(
		...
		Y('mousedown', function (e) {
			var t,
				...
				a = e.target;
			o === ue.Open &&
				((null == s ? void 0 : s.contains(a)) ||
					(null == l ? void 0 : l.contains(a)) ||
					(u({ type: de.ClosePopover }),
					(t = a),
					void 0 === (r = re.Loose) && (r = re.Strict),
					(t !== document.body &&
						O(
							r,
							(((n = {})[re.Strict] = function () {
								return t.matches(ae);
							}),
							(n[re.Loose] = function () {
								for (var e = t; null !== e; ) {
									if (e.matches(ae)) return !0;
									e = e.parentElement;
								}
								return !1;
							}),
						...
						(e.preventDefault(), null == s || s.focus())));
		});
	var m = v(
			function (e) {
				u({ type: de.ClosePopover });
			...
			c.createElement(
				ge,
				{
					value: O(
						...
						((t = {}),
						(t[ue.Open] = se.Open),
						(t[ue.Closed] = se.Closed),
						t)
					),
				},
				N({ props: e, slot: y, defaultTag: 'div', name: 'Popover' })
			)
		)
	);
}
var Le,
	Ce,
	_e = I(function e(t, r) {
		var n = xe([Ae.name, e.name].join('.')),
			a = n[0],
			i = n[1],
			o = y(null),
			s = qe(),
			l = null == s ? void 0 : s.closeOthers,
			c = w(De),
			u = null !== c && c === a.panelId,
			p = G(
				o,
				r,
				u
					? null
					: function (e) {
							return i({ type: de.SetButton, button: e });
					  }
			),
			d = G(o, r),
			f = y(null),
			h = y('undefined' == typeof window ? null : document.activeElement);
		Y(
			'focus',
			function () {
				(h.current = f.current), (f.current = document.activeElement);
			},
			!0
		);
		var m = v(
				function (e) {
					var t;
					if (u) {
						if (a.popoverState === ue.Closed) return;
						switch (e.key) {
							case U.Space:
							case U.Enter:
								e.preventDefault(),
									e.stopPropagation(),
									i({ type: de.ClosePopover }),
						...
						switch (e.key) {
							...
							case U.Enter:
								e.preventDefault(),
									e.stopPropagation(),
									a.popoverState === ue.Closed &&
										(null == l || l(a.buttonId)),
									i({ type: de.TogglePopover });
								break;
							case U.Escape:
								if (a.popoverState !== ue.Open)
									return null == l ? void 0 : l(a.buttonId);
								if (!o.current) return;
								if (!o.current.contains(document.activeElement))
									return;
								i({ type: de.ClosePopover });
								break;
							case U.Tab:
								if (a.popoverState !== ue.Open) return;
								if (!a.panel) return;
								if (!a.button) return;
								if (e.shiftKey) {
									var r;
									...
									if (
										null == (r = a.button)
											? void 0
											: r.contains(h.current)
									)
										return;
									if (a.panel.contains(h.current)) return;
									var n = ie(),
										s = n.indexOf(h.current);
									if (n.indexOf(a.button) > s) return;
									e.preventDefault(),
										e.stopPropagation(),
										oe(a.panel, X.Last);
								} else
				...
				[i, a.popoverState, a.buttonId, a.button, a.panel, o, l, u]
			),
			g = v(
				function (e) {
					var t;
					if (
						...
						a.popoverState === ue.Open && a.panel && a.button)
					)
						switch (e.key) {
							case U.Tab:
								if (!h.current) return;
								if (
									null == (t = a.button)
										? void 0
										: t.contains(h.current)
								)
									return;
								if (a.panel.contains(h.current)) return;
								var r = ie(),
									n = r.indexOf(h.current);
								if (r.indexOf(a.button) > n) return;
								e.preventDefault(),
									e.stopPropagation(),
									oe(a.panel, X.Last);
						}
				},
				[a.popoverState, a.panel, a.button, u]
			),
			x = v(
				function (e) {
					var r, n;
				...
				[i, a.button, a.popoverState, a.buttonId, t.disabled, l, u]
			),
			k = S(
				function () {
					return { open: a.popoverState === ue.Open };
				},
				[a]
			),
			E = (function (e, t) {
		...
		return N({
			props: L(
				...
				t,
				u
					? { ref: d, type: E, onKeyDown: m, onClick: x }
					: {
							ref: p,
							id: a.buttonId,
							type: E,
	...
	Oe = I(function e(t, r) {
		var n = xe([Ae.name, e.name].join('.')),
			...
			i = n[1],
			o = G(r),
			s = 'headlessui-popover-overlay-' + J(),
			l = me(),
			c = null !== l ? l === se.Open : a === ue.Open,
			u = v(
				function (e) {
			...
			p = S(
				function () {
					return { open: a === ue.Open };
				},
				[a]
			);
		return N({
			props: L({}, t, { ref: o, id: s, 'aria-hidden': !0, onClick: u }),
			slot: p,
			defaultTag: 'div',
			features: Be,
			visible: c,
	...
	Pe = I(function e(t, r) {
		var n = t.focus,
			a = void 0 !== n && n,
			i = C(t, ['focus']),
			o = xe([Ae.name, e.name].join('.')),
			s = o[0],
			l = o[1],
			u = Se([Ae.name, e.name].join('.')).close,
			p = y(null),
			d = G(p, r, function (e) {
				l({ type: de.SetPanel, panel: e });
			}),
			f = me(),
			h = null !== f ? f === se.Open : s.popoverState === ue.Open,
			m = v(
				function (e) {
					var t;
					switch (e.key) {
						case U.Escape:
							if (s.popoverState !== ue.Open) return;
							if (!p.current) return;
							if (!p.current.contains(document.activeElement))
								return;
							e.preventDefault(),
								l({ type: de.ClosePopover }),
		...
		g(
			function () {
				return function () {
					return l({ type: de.SetPanel, panel: null });
				};
			},
			[l]
		),
			g(
				function () {
					var e;
					s.popoverState !== ue.Closed ||
						(null != (e = t.unmount) && !e) ||
						l({ type: de.SetPanel, panel: null });
				},
				[s.popoverState, t.unmount, l]
			),
			g(
				function () {
					if (a && s.popoverState === ue.Open && p.current) {
						var e = document.activeElement;
						p.current.contains(e) || oe(p.current, X.First);
					}
				},
				[a, p, s.popoverState]
			),
			Y('keydown', function (e) {
				if (
					s.popoverState === ue.Open &&
					p.current &&
					e.key === U.Tab &&
					document.activeElement &&
					p.current &&
					p.current.contains(document.activeElement)
				) {
					e.preventDefault();
					var t,
						r = oe(p.current, e.shiftKey ? X.Previous : X.Next);
					if (r === Q.Underflow)
						return null == (t = s.button) ? void 0 : t.focus();
					if (r === Q.Overflow) {
						if (!s.button) return;
						var n = ie(),
							a = n.indexOf(s.button);
						oe(
							...
							X.First
						) === Q.Error && oe(document.body, X.First);
					}
				}
			}),
			Y(
		...
		var b = S(
				function () {
					return { open: s.popoverState === ue.Open, close: u };
				},
				[s, u]
			),
			w = { ref: d, id: s.panelId, onKeyDown: m };
		return c.createElement(
			De.Provider,
			{ value: s.panelId },
			N({
...
function Re(e) {
	for (
		var t, r = arguments.length, n = new Array(r > 1 ? r - 1 : 0), a = 1;
		a < r;
		a++
	)
		n[a - 1] = arguments[a];
		...
		c =
			void 0 !== i
				? ((o = i),
				  ...
				  function () {
						if (!s.called)
							return (s.called = !0), o.apply(void 0, arguments);
				  })
				: function () {};
	return (
		je.apply(void 0, [e].concat(a)),
		Re.apply(void 0, [e].concat(t, r)),
		l.nextFrame(function () {
			je.apply(void 0, [e].concat(r)),
				...
				l.add(
					(function (e, t) {
						...
						var n = getComputedStyle(e),
							a = [n.transitionDuration, n.transitionDelay].map(
								function (e) {
									var t = e
										.split(',')
										.filter(Boolean)
		...
		l.add(function () {
			return je.apply(void 0, [e].concat(t, r, n, a));
		}),
		l.add(function () {
		...
		var t = y(null),
			...
			s = v(
				function () {
					...
					return (
						!!(null == (e = t.current) ? void 0 : e.contains(r)) ||
						n.some(function (e) {
							var t, n;
							return (
								(null ==
								(t = document.getElementById(e.buttonId))
									? void 0
									: t.contains(r)) ||
								(null ==
			...
			l = v(
				function (e) {
					for (var t, r = B(n); !(t = r()).done; ) {
						var a = t.value;
						a.buttonId !== e && a.close();
					}
				},
				[n]
			),
...
function ze(e) {
	...
	var a = v(
			function (e, a) {
				...
				-1 !== o &&
					(O(
						a,
						(((i = {})[T.Unmount] = function () {
							r.current.splice(o, 1);
						}),
						(i[T.Hidden] = function () {
							r.current[o].state = Ue.Hidden;
						}),
						i)
					),
					!We(r) && n.current && (null == t.current || t.current()));
			},
			[t, n, r]
		),
		i = v(
			function (e) {
				...
				return (
					t
						? t.state !== Ue.Visible && (t.state = Ue.Visible)
						: r.current.push({ id: e, state: Ue.Visible }),
					function () {
						return a(e, T.Unmount);
					}
				);
			},
			[r, a]
	...
	return S(
		function () {
			return { children: r, register: i, unregister: a };
		},
		[i, a, r]
	);
}
...
var Je = ['beforeEnter', 'afterEnter', 'beforeLeave', 'afterLeave'];
function Ye(e) {
	for (var t, r = {}, n = B(Je); !(t = n()).done; ) {
		var a,
			i = t.value;
		r[i] = null != (a = e[i]) ? a : $e;
	}
...
function Ze(e) {
	var t,
		...
		x = v[0],
		k = v[1],
		S = h.unmount ? T.Unmount : T.Hidden,
		E = (function () {
			var e = w(He);
			if (null === e)
				throw new Error(
		...
		R = y(!1),
		M = ze(function () {
			R.current || (k(Ue.Hidden), B(I), Y.current.afterLeave());
		});
	j(
		function () {
			if (I) return _(I);
			...
			function () {
				...
				S === T.Hidden &&
					...
					(q && x !== Ue.Visible
						...
						: O(
								x,
								(((e = {})[Ue.Hidden] = function () {
									return B(I);
								}),
								(e[Ue.Visible] = function () {
									return _(I);
								}),
								e)
						  ));
	...
	var U = Fe(o),
		...
		})({ beforeEnter: r, afterEnter: n, beforeLeave: a, afterLeave: i }),
		X = F();
	g(
		function () {
			if (X && x === Ue.Visible && null === m.current)
				throw new Error(
	...
	j(
		function () {
			...
			if (e && !Z)
				return (
					(R.current = !0),
					q && Y.current.beforeEnter(),
					q || Y.current.beforeLeave(),
					q
						? Me(e, U, V, H, G, function (e) {
								(R.current = !1),
									e === Le.Finished && Y.current.afterEnter();
						  })
						: Me(e, W, z, $, G, function (e) {
								(R.current = !1),
									e === Le.Finished &&
										(We(M) ||
											(k(Ue.Hidden),
		...
		c.createElement(
			ge,
			{
				value: O(
					x,
					((t = {}),
					(t[Ue.Visible] = se.Open),
					(t[Ue.Hidden] = se.Closed),
					t)
				),
			},
			N({
...
function Qe(e) {
	var t,
		...
		a = void 0 !== n && n,
		i = e.unmount,
		o = C(e, ['show', 'appear', 'unmount']),
		s = me();
	void 0 === r &&
		null !== s &&
		(r = O(s, (((t = {})[se.Open] = !0), (t[se.Closed] = !1), t)));
	if (![!0, !1].includes(r))
		throw new Error(
			'A <Transition /> is used but it is missing a `show={true | false}` prop.'
		);
	var l = b(r ? Ue.Visible : Ue.Hidden),
		p = l[0],
		d = l[1],
		f = ze(function () {
			d(Ue.Hidden);
		...
		m = S(
			function () {
				return { show: r, appear: a || !h };
			},
			[r, a, h]
		);
	g(
		function () {
			r ? d(Ue.Visible) : We(f) || d(Ue.Hidden);
		},
		[r, f]
	);
	var v = { unmount: i };
	return c.createElement(
		...
		c.createElement(
			...
			N({
				props: L({}, v, {
					as: u,
					children: c.createElement(Ze, Object.assign({}, v, o)),
				}),
				defaultTag: u,
				features: Xe,
				visible: p === Ue.Visible,
				name: 'Transition',
			})
		)
	);
...
function at(e, t) {
	return Ke(2, arguments), et(e).getTime() - et(t).getTime();
}
(Qe.Child = function (e) {
	var t = null !== w(He),
		r = null !== me();
	return !t && r
		? c.createElement(Qe, Object.assign({}, e))
		: c.createElement(Ze, Object.assign({}, e));
}),
	(Qe.Root = Qe);
var it = {
	ceil: Math.ceil,
...
function ct(e) {
	Ke(1, arguments);
	var t = et(e);
	return st(t).getTime() === lt(t).getTime();
}
function ut(e, t) {
	Ke(2, arguments);
	var r,
...
function pt(e, t, r) {
	Ke(2, arguments);
	var n = at(e, t) / 1e3;
	return ot(null == r ? void 0 : r.roundingMethod)(n);
}
var dt = {
		lessThanXSeconds: {
...
function yt(e) {
	return function (t) {
		...
		(o = e.valueCallback ? e.valueCallback(c) : c),
...
(qt = Ct),
	...
	(qt.Doctype =
		...
		qt.ElementType =
			void 0),
	((Tt = Dt = qt.ElementType || (qt.ElementType = {})).Root = 'root'),
	(Tt.Text = 'text'),
	...
	(Tt.Doctype = 'doctype'),
	(qt.isTag = function (e) {
		return e.type === Dt.Tag || e.type === Dt.Script || e.type === Dt.Style;
	}),
	(qt.Root = Dt.Root),
	(qt.Text = Dt.Text),
	(qt.Directive = Dt.Directive),
	(qt.Comment = Dt.Comment),
	(qt.Script = Dt.Script),
	(qt.Style = Dt.Style),
	(qt.Tag = Dt.Tag),
	(qt.CDATA = Dt.CDATA),
	(qt.Doctype = Dt.Doctype);
var _t,
	Bt = {},
	Ot =
		(H && H.__extends) ||
	...
	Rt = (function () {
		...
		return (
			Object.defineProperty(e.prototype, 'nodeType', {
				get: function () {
					var e;
					return null !== (e = It.get(this.type)) && void 0 !== e
						? e
						: 1;
				},
				enumerable: !1,
...
var Mt = (function (e) {
	function t(t) {
		return e.call(this, Pt.ElementType.Text, t) || this;
	}
	return Ot(t, e), t;
})(jt);
Bt.Text = Mt;
var Ft = (function (e) {
	function t(t) {
		return e.call(this, Pt.ElementType.Comment, t) || this;
	}
	return Ot(t, e), t;
})(jt);
Bt.Comment = Ft;
var Ut = (function (e) {
	function t(t, r) {
		var n = e.call(this, Pt.ElementType.Directive, r) || this;
		return (n.name = t), n;
	}
	return Ot(t, e), t;
})(jt);
Bt.ProcessingInstruction = Ut;
var Vt = (function (e) {
	function t(t, r) {
		var n = e.call(this, t) || this;
...
Bt.NodeWithChildren = Vt;
var Ht = (function (e) {
	function t(t) {
		return e.call(this, Pt.ElementType.Root, t) || this;
	}
	return Ot(t, e), t;
})(Vt);
Bt.Document = Ht;
	...
	function t(t, r, n, a) {
		void 0 === n && (n = []),
			void 0 === a &&
				(a =
					'script' === t
						? Pt.ElementType.Script
						: 'style' === t
						? Pt.ElementType.Style
						: Pt.ElementType.Tag);
...
function zt(e) {
	return e.type === Pt.ElementType.CDATA;
}
function $t(e) {
	return e.type === Pt.ElementType.Text;
}
function Jt(e) {
	return e.type === Pt.ElementType.Comment;
}
function Yt(e) {
	return e.type === Pt.ElementType.Directive;
}
function Xt(e) {
	return e.type === Pt.ElementType.Root;
}
function Zt(e, t) {
	var r;
	if ((void 0 === t && (t = !1), $t(e))) r = new Mt(e.data);
	else if (Jt(e)) r = new Ft(e.data);
	else if (Wt(e)) {
		var n = t ? Qt(e.children) : [],
			a = new Gt(e.name, Nt({}, e.attribs), n);
		n.forEach(function (e) {
			return (e.parent = a);
		}),
			e['x-attribsNamespace'] &&
				(a['x-attribsNamespace'] = Nt({}, e['x-attribsNamespace'])),
			e['x-attribsPrefix'] &&
				(a['x-attribsPrefix'] = Nt({}, e['x-attribsPrefix'])),
			(r = a);
	} else if (zt(e)) {
		n = t ? Qt(e.children) : [];
		var i = new Vt(Pt.ElementType.CDATA, n);
		n.forEach(function (e) {
			return (e.parent = i);
		}),
			(r = i);
		...
		if (!Yt(e)) throw new Error('Not implemented yet: ' + e.type);
		var s = new Ut(e.name, e.data);
		null != e['x-name'] &&
			((s['x-name'] = e['x-name']),
			...
			s = (function () {
				...
				return (
					...
					(e.prototype.oncdatastart = function () {
						var e = new a.Text(''),
							t = new a.NodeWithChildren(n.ElementType.CDATA, [
								e,
							]);
...
(er = H),
	(tr = function () {
		...
		function i(e, t, i) {
			if (e instanceof n) {
				var o = e;
				i = t;
			} else o = n.fromCompiled(e, t);
			for (var s in ((this.grammar = o),
			(this.options = { keepHistory: !1, lexer: o.lexer || new a() }),
			i || {}))
				this.options[s] = i[s];
				...
				for (
					...
					if (o.isComplete) {
						if ((o.finish(), o.data !== i.fail)) {
							for (var s = o.wantedBy, l = s.length; l--; ) {
								var c = s[l];
								this.complete(c, o);
							}
							if (o.reference === this.index) {
								var u = o.rule.name;
								(this.completed[u] =
									this.completed[u] || []).push(o);
							}
						}
					} else {
						if ('string' != typeof (u = o.rule.symbols[o.dot])) {
							this.scannable.push(o);
							continue;
						}
						if (r[u]) {
							if ((r[u].push(o), n.hasOwnProperty(u))) {
								var p = n[u];
			...
			(a.prototype.formatError = function (e, t) {
				...
				if ('string' == typeof r) {
					...
					var a = this.index - this.lastLineBreak,
						i = String(this.line).length;
					return (
						(t += ' at line ' + this.line + ' col ' + a + ':\n\n'),
						(t += n
							.map(function (e, t) {
								return (
									o(this.line - n.length + t + 1, i) + ' ' + e
								);
							}, this)
							.join('\n')),
						(t += '\n' + o('', i + a) + '^\n')
			...
			(i.prototype.feed = function (e) {
				...
				for (n.reset(e, this.lexerState); ; ) {
					try {
						...
						throw (
							(this.table.push(i),
							((l = new Error(this.reportLexerError(g))).offset =
								this.current),
							(l.token = g.token),
							l)
						);
					...
					this.options.keepHistory && (o.lexerState = n.save()),
						this.current++;
				}
				return (
					o && (this.lexerState = n.save()),
	...
	(Kt = ar).exports ? (Kt.exports = tr()) : (er.nearley = tr());
var ir = { exports: {} };
!(function (e) {
	!(function (t, r) {
		...
		function l(t, r) {
			...
			for (var o in r) e.call(r, o) && (i[o] = r[o]);
			if ('string' == typeof i.type && t !== i.type)
				throw new Error(
			...
			var s = i.match;
			return (
				(i.match = Array.isArray(s) ? s : s ? [s] : []),
				i.match.sort(function (e, t) {
					return n(e) && n(t)
						? 0
						: n(t)
						? -1
				...
				? (function (e) {
						for (var t = [], r = 0; r < e.length; r++) {
							...
							if (n.include)
								...
								if (!n.type)
									throw new Error(
										'Rule has no type: ' + JSON.stringify(n)
									);
								t.push(l(n.type, n));
							}
						}
			...
			for (h = 0; h < e.length; h++) {
				...
				if (0 !== g.length) {
					...
					var y = o(g.map(s)),
						w = new RegExp(y);
					if (w.test(''))
						throw new Error('RegExp matches empty string: ' + w);
		...
		if (
			...
			(f.prototype.next = function () {
				...
				var r = this.buffer;
				if (e !== r.length) {
					if ((o = this.fast[r.charCodeAt(e)]))
						return this._token(o, r.charAt(e), e);
					var n = this.re;
					n.lastIndex = e;
					var a = h(n, r),
						i = this.error;
					if (null == a)
						return this._token(i, r.slice(e, r.length), e);
					var o = this._getGroup(a),
						s = a[0];
					return i.fallback && a.index !== e
						? ((this.queuedGroup = o),
						  (this.queuedText = s),
						  this._token(i, r.slice(e, a.index), e))
						: this._token(o, s, e);
				}
			}),
			(f.prototype._token = function (e, t, r) {
				...
				if (e.lineBreaks) {
					var a = /\n/g,
						i = 1;
					if ('\n' === t) n = 1;
					else for (; a.exec(t); ) n++, (i = a.lastIndex);
				}
				var o = {
						type:
		...
		return (
			(f.prototype.formatError = function (e, t) {
				...
				var n = Math.max(0, e.offset - e.col + 1),
					...
					i = this.buffer.substring(n, e.offset + a);
				return (
			...
			}),
			{
				...
				states: function (e, t) {
					...
					t || (t = n[0]);
					for (
						var a = Object.create(null), i = 0;
						i < n.length;
						i++
					) {
						a[(y = n[i])] = c(e[y]).concat(r);
					}
							...
							if (u.include) {
								...
								if (u.include !== y && !s[u.include]) {
									...
									for (var g = 0; g < m.length; g++) {
										var b = m[g];
										-1 === o.indexOf(b) && h.push(b);
									}
								}
								o.splice.apply(o, h), l--;
							}
						}
					...
					for (i = 0; i < n.length; i++) {
						...
						for (l = 0; l < S.length; l++) d(x.fast[S[l]], w, v);
					}
					return new f(v, t);
				},
...
const cr = sr(ir.exports).compile({
	ws: { match: /[ \t\r\n\f]+/, lineBreaks: !0 },
...
const fr = {
	Lexer: cr,
	ParserRules: [
		{ name: 'main', symbols: ['_', 'listSelector', '_'], postprocess: pr },
		{
			name: 'mainNoList',
		...
		},
		{
			...
			postprocess: ([e, , t]) => ({
				...
				specificity: dr(e.specificity, t.specificity),
			}),
		},
		{
			name: 'complexSelector',
			...
			postprocess: ([e, , t, , r]) => ({
				...
				specificity: dr(e.specificity, r.specificity),
			}),
		},
		{
			name: 'combinator',
			symbols: [cr.has('gt') ? { type: 'gt' } : gt],
			postprocess: () => '>',
		},
		{
			name: 'combinator',
			symbols: [cr.has('plus') ? { type: 'plus' } : plus],
			postprocess: () => '+',
		},
		{
			name: 'combinator',
			symbols: [cr.has('tilde') ? { type: 'tilde' } : tilde],
			postprocess: () => '~',
		},
		{
			name: 'combinator',
			symbols: [
				cr.has('vbar') ? { type: 'vbar' } : vbar,
				cr.has('vbar') ? { type: 'vbar' } : vbar,
			],
			postprocess: () => '||',
		},
		...
		{ name: 'subclassSelector', symbols: ['idSelector'], postprocess: lr },
		{
		...
		{ name: 'typeSelector', symbols: ['tagSelector'], postprocess: lr },
		{ name: 'typeSelector', symbols: ['uniSelector'], postprocess: lr },
		{
			name: 'attrPresenceSelector',
			symbols: [
				cr.has('lbr') ? { type: 'lbr' } : lbr,
				'_',
				'wqname',
				'_',
				cr.has('rbr') ? { type: 'rbr' } : rbr,
			],
			postprocess: ([, , e]) => ({
				type: 'attrPresence',
				name: e.name,
		...
		{
			name: 'attrMatcher',
			symbols: [cr.has('eq') ? { type: 'eq' } : eq],
			postprocess: () => '=',
		},
		{
			name: 'attrMatcher',
			symbols: [
				cr.has('tilde') ? { type: 'tilde' } : tilde,
				cr.has('eq') ? { type: 'eq' } : eq,
			],
			postprocess: () => '~=',
		},
		{
		...
		},
		{
			name: 'attrMatcher',
			symbols: [
				cr.has('dollar') ? { type: 'dollar' } : dollar,
				cr.has('eq') ? { type: 'eq' } : eq,
			],
			postprocess: () => '$=',
		},
		{
			name: 'attrMatcher',
			symbols: [
				cr.has('asterisk') ? { type: 'asterisk' } : asterisk,
				cr.has('eq') ? { type: 'eq' } : eq,
			],
			postprocess: () => '*=',
		},
		...
		{
			name: 'idSelector',
			symbols: [cr.has('hashToken') ? { type: 'hashToken' } : hashToken],
			postprocess: ([{ value: e }]) => ({
				type: 'id',
				name: e,
				specificity: [1, 0, 0],
		...
		},
		{
			name: 'classSelector',
			symbols: [
				cr.has('fullstop') ? { type: 'fullstop' } : fullstop,
				'idn',
			],
			postprocess: ([, e]) => ({
				type: 'class',
		...
		{
			name: 'uniSelector',
			symbols: [cr.has('asterisk') ? { type: 'asterisk' } : asterisk],
			postprocess: () => ({
				type: 'universal',
				namespace: null,
				specificity: [0, 0, 0],
		...
		{
			name: 'ns',
			symbols: [cr.has('vbar') ? { type: 'vbar' } : vbar],
			postprocess: () => '',
		},
		{
			name: 'ns',
			symbols: ['idn', cr.has('vbar') ? { type: 'vbar' } : vbar],
			postprocess: lr,
		},
		{
			name: 'str',
			symbols: [cr.has('str1') ? { type: 'str1' } : str1],
			postprocess: ur,
		},
		{
			name: 'str',
			symbols: [cr.has('str2') ? { type: 'str2' } : str2],
			postprocess: ur,
		},
		{
			name: 'idn',
			symbols: [cr.has('idn') ? { type: 'idn' } : idn],
			postprocess: ur,
		},
		{
			name: '_$ebnf$1',
			symbols: [cr.has('ws') ? { type: 'ws' } : ws],
			postprocess: lr,
		},
...
var hr = Object.freeze({ __proto__: null });
const mr = l(s({}, fr), { ParserStart: 'mainNoList' });
function gr(e, t) {
	const r = new or.Parser(or.Grammar.fromCompiled(e));
...
function br(e) {
	...
	switch (e.type) {
		case 'universal':
			return vr(e.namespace) + '*';
		case 'tag':
			return vr(e.namespace) + e.name;
		case 'class':
			return '.' + e.name;
		case 'id':
			return '#' + e.name;
		case 'attrPresence':
			return `[${vr(e.namespace)}${e.name}]`;
		case 'attrValue':
			return `[${vr(e.namespace)}${e.name}${e.matcher}${
				((t = e.value),
				-1 === t.indexOf('"')
					? `"${t}"`
					: -1 === t.indexOf("'")
		...
		case 'combinator':
			return br(e.left) + e.combinator;
		case 'compound':
			return e.list.reduce(
				(e, t) => ('combinator' === t.type ? br(t) + e : e + br(t)),
				''
			);
		case 'list':
			return e.list.map(br).join(',');
	}
	var t;
}
function vr(e) {
...
(nr.Ast = hr),
	(nr.compareSelectors = function (e, t) {
		return wr(e.specificity, t.specificity);
	}),
	(nr.compareSpecificity = function (e, t) {
		return wr(e, t);
	}),
	(nr.normalize = function e(t) {
		if (!t.type) throw new Error('This is not an AST node.');
		switch (t.type) {
			case 'compound':
				t.list.forEach(e), t.list.sort((e, t) => wr(yr(e), yr(t)));
				break;
			case 'combinator':
				e(t.left);
				break;
...
var Sr = kr(xr),
	Er = Object.freeze({ __proto__: null }),
	qr = Object.freeze({ __proto__: null });
const Dr = [
		['├─', '│ '],
		['└─', '  '],
	],
...
var Cr = Object.freeze({ __proto__: null, treeify: (e) => '▽\n' + Lr(e, Dr) });
function _r(e) {
	return Br(e), Sr.normalize(e), e;
}
function Br(e) {
	const t = [];
	e.list.forEach((e) => {
...
function Or(e) {
	...
	for (; e.length; ) {
		const r = Vr(e, (e) => !0, Ir),
			{ matches: n, nonmatches: a, empty: i } = Pr(e, r);
		(e = a), n.length && t.push(Rr(r, n)), i.length && t.push(...Nr(i));
	}
	return t;
}
function Nr(e) {
	...
	for (const r of e) {
		...
		if ('terminal' === e.type) t.push(e);
			...
			const { matches: r, rest: n } = Hr(
				e.cont,
				(e) => 'terminal' === e.type
			);
			r.forEach((e) => t.push(e)), n.length && ((e.cont = n), t.push(e));
		}
	}
	return t;
}
...
function Rr(e, t) {
	...
	if (e.startsWith('attrPresence '))
		return (function (e, t) {
			for (const r of t)
				Ur(r, (t) => 'attrPresence' === t.type && t.name === e);
			return { type: 'attrPresence', name: e, cont: Or(t) };
		})(e.substring(13), t);
	if ('combinator >' === e) return Mr('>', t);
	if ('combinator +' === e) return Mr('+', t);
...
function Mr(e, t) {
	...
	return { type: 'pushElement', combinator: e, cont: Or(n) };
}
function Fr(e, t, r) {
	const n = {};
	for (; e.length; ) {
		const a = Vr(e, t, r),
			i = (e) => t(e) && r(e) === a,
			o = (e) => e.ast.list.some(i),
			{ matches: s, rest: l } = Gr(e, o);
		let c = null;
		for (const e of s) {
			const t = Ur(e, i);
			c || (c = t);
...
function Ur(e, t) {
	...
	let a = -1;
	for (let o = r.length; o-- > 0; ) t(r[o]) && ((n[o] = !0), (a = o));
	if (-1 == a) throw new Error("Couldn't find the required simple selector.");
	const i = r[a];
	return (e.ast.list = r.filter((e, t) => !n[t])), i;
}
function Vr(e, t, r) {
	const n = {};
	for (const o of e) {
		const e = {};
		for (const n of o.ast.list.filter(t)) e[r(n)] = !0;
		for (const t of Object.keys(e)) n[t] ? n[t]++ : (n[t] = 1);
	}
	let a = '',
		i = 0;
	for (const o of Object.entries(n)) o[1] > i && ((a = o[0]), (i = o[1]));
	return a;
}
function Hr(e, t) {
	const r = [],
...
function Wr(e, t) {
	const r = xr.compareSpecificity(t.specificity, e.specificity);
...
function Xr(e) {
	switch (e.type) {
		...
		case 'tagName':
			return (function (e) {
				const t = {};
				for (const r of e.variants) t[r.value] = Yr(r.cont);
				return (e, ...r) => {
					const n = t[e.name];
					return n ? n(e, ...r) : [];
				};
...
const Zr = (e) => {
		const t = e.prev;
		return null === t ? null : $r.isTag(t) ? t : Zr(t);
	},
	Qr = (e) => {
		const t = e.parent;
...
At.hp2Builder = function (e) {
	return new Jr.Picker(Yr(e));
};
var en = function (e) {
	return (
		(function (e) {
	...
	return (
		...
		an(t).forEach(function (a) {
			(function (e, t) {
				...
				(on(e, a) && r.isMergeableObject(t[a])
					? (n[a] = (function (e, t) {
							if (!t.customMerge) return ln;
							var r = t.customMerge(e);
							return 'function' == typeof r ? r : ln;
					  })(a, r)(e[a], t[a], r))
					: (n[a] = rn(t[a], r)));
		}),
		n
...
function ln(e, t, r) {
	((r = r || {}).arrayMerge = r.arrayMerge || nn),
		(r.isMergeableObject = r.isMergeableObject || en),
		(r.cloneUnlessOtherwiseSpecified = rn);
...
!(function (e, t) {
	!(function (r) {
		...
		var o = /[\uD800-\uDBFF][\uDC00-\uDFFF]/g,
			...
			E = function (e, t) {
				...
				return (e >= 55296 && e <= 57343) || e > 1114111
					? (t &&
					  ...
					  '�')
					: k(v, e)
					? (t && T('disallowed character reference'), v[e])
					: (t &&
							(function (e, t) {
							...
							T('disallowed character reference'),
					  e > 65535 &&
			...
			A = function (e, t) {
				(t = S(t, A.options)).strict &&
					h.test(e) &&
					T('forbidden code point');
		...
		var L = function (e, t) {
			var r = (t = S(t, L.options)).strict;
			return (
				r && f.test(e) && T('malformed character reference'),
		...
		if (n && !n.nodeType)
			if (a) a.exports = C;
			else for (var _ in C) k(C, _) && (n[_] = C[_]);
		else r.he = C;
	})(H);
})(un, un.exports);
var pn = {},
...
hn.default = function (e) {
	return (e >= 55296 && e <= 57343) || e > 1114111
		? '�'
		: (e in gn.default && (e = gn.default[e]), bn(e));
};
var vn = {
	Aacute: 'Á',
	aacute: 'á',
	...
	ia = (function () {
		...
		return (
			...
			(e.prototype.stateInSelfClosingTag = function (e) {
				'>' === e
					? (this.cbs.onselfclosingtag(),
					  ...
					  (this.sectionStart = this._index + 1),
					  (this.special = 1))
					: Dn(e) || ((this._state = 8), this._index--);
			}),
			...
			(e.prototype.parseFixedEntity = function (e) {
				if (
					(void 0 === e &&
						(e = this.xmlMode ? qn.default : Sn.default),
			...
			(e.prototype.parseLegacyEntity = function () {
				for (
					...
					if (Object.prototype.hasOwnProperty.call(En.default, r))
						return (
							this.emitPartial(En.default[r]),
				...
				';' === e
					...
					: (e < '0' || e > '9') &&
					  ...
					  (this.xmlMode ||
							this.sectionStart + 1 === this._index ||
							(1 !== this.baseState
								? '=' !== e && this.parseFixedEntity(En.default)
								: this.parseLegacyEntity()),
					  (this._state = this.baseState),
					  this._index--);
			}),
...
Object.defineProperty(dn, '__esModule', { value: !0 }), (dn.Parser = void 0);
var sa = oa(fn),
	la = new Set([
		'input',
		'option',
			...
			void 0 === t && (t = {}),
				...
				(this.lowerCaseAttributeNames =
					null !== (n = t.lowerCaseAttributeNames) && void 0 !== n
						...
						: !t.xmlMode),
				(this.tokenizer = new (
					null !== (a = t.Tokenizer) && void 0 !== a ? a : sa.default
				)(this.options, this)),
				null === (o = (i = this.cbs).onparserinit) ||
					void 0 === o ||
					o.call(i, this);
		}
		return (
			...
			(e.prototype.onopentagname = function (e) {
				...
				if (
					...
					!this.options.xmlMode &&
						Object.prototype.hasOwnProperty.call(ua, e))
				)
					for (
						var n = void 0;
						this.stack.length > 0 &&
						ua[e].has((n = this.stack[this.stack.length - 1]));

					)
						this.onclosetag(n);
				(!this.options.xmlMode && pa.has(e)) ||
					(this.stack.push(e),
					da.has(e)
						? this.foreignContext.push(!0)
						: fa.has(e) && this.foreignContext.push(!1)),
			...
			(e.prototype.onclosetag = function (e) {
				if (
					(this.updatePosition(1),
					this.lowerCaseTagNames && (e = e.toLowerCase()),
					(da.has(e) || fa.has(e)) && this.foreignContext.pop(),
					!this.stack.length || (!this.options.xmlMode && pa.has(e)))
				)
					this.options.xmlMode ||
						('br' !== e && 'p' !== e) ||
...
var Sa = ka(vn),
	...
	qa = ka(wn),
	Da = ka(hn),
	Ta = /&(?:[a-zA-Z0-9]+|#[xX][\da-fA-F]+|#\d+);/g;
function Aa(e) {
	var t = Ca(e);
	return function (e) {
		return String(e).replace(Ta, t);
	};
}
(xa.decodeXML = Aa(qa.default)), (xa.decodeHTMLStrict = Aa(Sa.default));
var La = function (e, t) {
	return e < t ? 1 : -1;
};
function Ca(e) {
	return function (t) {
		if ('#' === t.charAt(1)) {
			var r = t.charAt(2);
			return 'X' === r || 'x' === r
				? Da.default(parseInt(t.substr(3), 16))
				: Da.default(parseInt(t.substr(2), 10));
		}
...
xa.decodeHTML = (function () {
	for (
		var e = Object.keys(Ea.default).sort(La),
			t = Object.keys(Sa.default).sort(La),
			r = 0,
			n = 0;
		r < t.length;
		r++
...
Object.defineProperty(_a, '__esModule', { value: !0 }),
	(_a.escapeUTF8 =
		_a.escape =
		_a.encodeNonAsciiHTML =
		_a.encodeHTML =
		_a.encodeXML =
			void 0);
var Oa = Ma(Ba(wn).default),
	Na = Fa(Oa);
_a.encodeXML = Wa(Oa);
var Pa,
	Ia,
...
function Ha(e) {
	return (
		'&#x' +
		(e.length > 1 ? Va(e) : e.charCodeAt(0)).toString(16).toUpperCase() +
		';'
	);
}
var Ga = new RegExp(Na.source + '|' + Ua.source, 'g');
function Wa(e) {
	return function (t) {
		return t.replace(Ga, function (t) {
			return e[t] || Ha(t);
		});
	};
}
(_a.escape = function (e) {
	return e.replace(Ga, Ha);
}),
	(_a.escapeUTF8 = function (e) {
		return e.replace(Na, Ha);
	}),
	(function (e) {
		Object.defineProperty(e, '__esModule', { value: !0 }),
			(e.decodeXMLStrict =
...
Object.defineProperty(za, '__esModule', { value: !0 }),
	(za.attributeNames = za.elementNames = void 0),
	(za.elementNames = new Map([
		['altglyph', 'altGlyph'],
	...
	switch (e.type) {
		...
		case Za.Tag:
			return (function (e, t) {
				...
				'foreign' === t.xmlMode &&
					((e.name =
						null !== (r = Ka.elementNames.get(e.name)) &&
						void 0 !== r
							? r
							: e.name),
					e.parent &&
						ai.has(e.parent.name) &&
						(t = $a($a({}, t), { xmlMode: !1 })));
				!t.xmlMode &&
					ii.has(e.name) &&
					(t = $a($a({}, t), { xmlMode: 'foreign' }));
				var n = '<' + e.name,
					a = (function (e, t) {
						if (e)
							return Object.keys(e)
				...
				(t.xmlMode
					? !1 !== t.selfClosingTags
					: t.selfClosingTags && ti.has(e.name))
					? (t.xmlMode || (n += ' '), (n += '/>'))
					: ((n += '>'),
					  e.children.length > 0 && (n += ri(e.children, t)),
					  (!t.xmlMode && ti.has(e.name)) ||
							(n += '</' + e.name + '>'));
				return n;
			})(e, t);
		case Za.Text:
			return (function (e, t) {
				var r = e.data || '';
				!1 === t.decodeEntities ||
					(!t.xmlMode && e.parent && ei.has(e.parent.name)) ||
					(r = Qa.encodeXML(r));
				return r;
			})(e, t);
	}
...
var si = Lt,
	...
	ci = Ct;
function ui(e, t) {
	return (0, li.default)(e, t);
}
(va.getOuterHTML = ui),
	(va.getInnerHTML = function (e, t) {
		return (0, si.hasChildren)(e)
			? e.children
					.map(function (e) {
						return ui(e, t);
					})
	...
	(va.textContent = function e(t) {
		return Array.isArray(t)
			? t.map(e).join('')
			: (0, si.hasChildren)(t) && !(0, si.isComment)(t)
			? e(t.children)
			: (0, si.isText)(t)
			? t.data
			: '';
	}),
	(va.innerText = function e(t) {
		return Array.isArray(t)
			? t.map(e).join('')
			: (0, si.hasChildren)(t) &&
			  (t.type === ci.ElementType.Tag || (0, si.isCDATA)(t))
			? e(t.children)
			: (0, si.isText)(t)
			? t.data
			: '';
...
Object.defineProperty(pi, '__esModule', { value: !0 }),
	(pi.prevElementSibling =
		pi.nextElementSibling =
		pi.getName =
		pi.hasAttrib =
		pi.getAttributeValue =
		pi.getSiblings =
		pi.getParent =
		pi.getChildren =
			void 0);
...
function hi(e) {
	var t;
	return null !== (t = e.children) && void 0 !== t ? t : fi;
}
function mi(e) {
...
(pi.getChildren = hi),
	...
	(pi.getName = function (e) {
		return e.name;
	}),
	(pi.nextElementSibling = function (e) {
		for (var t = e.next; null !== t && !(0, di.isTag)(t); ) t = t.next;
		return t;
	}),
	(pi.prevElementSibling = function (e) {
		for (var t = e.prev; null !== t && !(0, di.isTag)(t); ) t = t.prev;
		return t;
	});
var gi = {};
function bi(e) {
...
Object.defineProperty(gi, '__esModule', { value: !0 }),
	(gi.prepend =
		...
		gi.removeElement =
			void 0),
	(gi.removeElement = bi),
	(gi.replaceElement = function (e, t) {
		var r = (t.prev = e.prev);
		r && (r.next = t);
		var n = (t.next = e.next);
		n && (n.prev = t);
	...
	(gi.appendChild = function (e, t) {
		if ((bi(t), (t.next = null), (t.parent = e), e.children.push(t) > 1)) {
			var r = e.children[e.children.length - 2];
			(r.next = t), (t.prev = r);
		} else t.prev = null;
	}),
	(gi.append = function (e, t) {
		bi(t);
		var r = e.parent,
			n = e.next;
...
function wi(e, t, r, n) {
	for (var a = [], i = 0, o = t; i < o.length; i++) {
		...
		if (r && (0, yi.hasChildren)(s) && s.children.length > 0) {
			var l = wi(e, s.children, r, n);
			if ((a.push.apply(a, l), (n -= l.length) <= 0)) break;
		}
	}
	return a;
}
(vi.filter = function (e, t, r, n) {
	return (
		void 0 === r && (r = !0),
		void 0 === n && (n = 1 / 0),
		Array.isArray(t) || (t = [t]),
	...
	(vi.find = wi),
	(vi.findOneChild = function (e, t) {
		return t.find(e);
	}),
	(vi.findOne = function e(t, r, n) {
		void 0 === n && (n = !0);
		for (var a = null, i = 0; i < r.length && !a; i++) {
			var o = r[i];
			(0, yi.isTag)(o) &&
				(t(o)
					? (a = o)
					: n && o.children.length > 0 && (a = e(t, o.children)));
		}
		return a;
	}),
	(vi.existsOne = function e(t, r) {
	...
	(vi.findAll = function (e, t) {
		for (var r, n, a = [], i = t.filter(yi.isTag); (n = i.shift()); ) {
			var o =
				null === (r = n.children) || void 0 === r
					? void 0
					: r.filter(yi.isTag);
			o && o.length > 0 && i.unshift.apply(i, o), e(n) && a.push(n);
		}
		return a;
	});
var xi = {};
Object.defineProperty(xi, '__esModule', { value: !0 }),
	(xi.getElementsByTagType =
	...
	Ei = {
		tag_name: function (e) {
			return 'function' == typeof e
				? function (t) {
						return (0, ki.isTag)(t) && e(t.name);
				  }
				: '*' === e
				? ki.isTag
				: function (t) {
						return (0, ki.isTag)(t) && t.name === e;
				  };
		},
		tag_type: function (e) {
			return 'function' == typeof e
		...
		tag_contains: function (e) {
			return 'function' == typeof e
				? function (t) {
						return (0, ki.isText)(t) && e(t.data);
				  }
				: function (t) {
						return (0, ki.isText)(t) && t.data === e;
				  };
		},
	};
function qi(e, t) {
	return 'function' == typeof t
		? function (r) {
				return (0, ki.isTag)(r) && t(r.attribs[e]);
		  }
		: function (r) {
				return (0, ki.isTag)(r) && r.attribs[e] === t;
		  };
}
function Di(e, t) {
	return function (r) {
...
function Ti(e) {
	var t = Object.keys(e).map(function (t) {
		var r = e[t];
		return Object.prototype.hasOwnProperty.call(Ei, t)
			? Ei[t](r)
			: qi(t, r);
	});
	return 0 === t.length ? null : t.reduce(Di);
}
(xi.testElement = function (e, t) {
	var r = Ti(e);
	return !r || r(t);
}),
	(xi.getElements = function (e, t, r, n) {
		void 0 === n && (n = 1 / 0);
		var a = Ti(e);
		return a ? (0, Si.filter)(a, t, r, n) : [];
	}),
	(xi.getElementById = function (e, t, r) {
		return (
			void 0 === r && (r = !0),
			Array.isArray(t) || (t = [t]),
			(0, Si.findOne)(qi('id', e), t, r)
		);
	}),
	(xi.getElementsByTagName = function (e, t, r, n) {
		return (
			void 0 === r && (r = !0),
			void 0 === n && (n = 1 / 0),
			(0, Si.filter)(Ei.tag_name(e), t, r, n)
		);
	}),
	(xi.getElementsByTagType = function (e, t, r, n) {
		return (
			void 0 === r && (r = !0),
			void 0 === n && (n = 1 / 0),
			(0, Si.filter)(Ei.tag_type(e), t, r, n)
		);
	});
var Ai = {};
Object.defineProperty(Ai, '__esModule', { value: !0 }),
	(Ai.uniqueSort = Ai.compareDocumentPosition = Ai.removeSubsets = void 0);
var Li = Lt;
function Ci(e, t) {
	var r = [],
		n = [];
	if (e === t) return 0;
	for (var a = (0, Li.hasChildren)(e) ? e : e.parent; a; )
		r.unshift(a), (a = a.parent);
	for (a = (0, Li.hasChildren)(t) ? t : t.parent; a; )
		n.unshift(a), (a = a.parent);
	for (var i = Math.min(r.length, n.length), o = 0; o < i && r[o] === n[o]; )
		o++;
	if (0 === o) return 1;
	var s = r[o - 1],
		l = s.children,
		c = r[o],
		u = n[o];
	return l.indexOf(c) > l.indexOf(u) ? (s === t ? 20 : 4) : s === e ? 10 : 2;
}
(Ai.removeSubsets = function (e) {
	...
	(Ai.compareDocumentPosition = Ci),
	(Ai.uniqueSort = function (e) {
		return (
...
var _i = {};
Object.defineProperty(_i, '__esModule', { value: !0 }), (_i.getFeed = void 0);
var Bi = va,
	Oi = xi;
_i.getFeed = function (e) {
	var t = Ri(Fi, e);
	return t
		? 'feed' === t.name
			? (function (e) {
					var t,
						...
						n = {
							type: 'atom',
							items: (0, Oi.getElementsByTagName)('entry', r).map(
								function (e) {
									var t,
										r = e.children,
										n = { media: Ii(r) };
					...
					var a =
						null === (t = Ri('link', r)) || void 0 === t
							? void 0
							: t.attribs.href;
					a && (n.link = a);
					Mi(n, 'description', 'subtitle', r);
					var i = ji('updated', r);
					i && (n.updated = new Date(i));
					return Mi(n, 'author', 'email', r, !0), n;
			  })(t)
			: (function (e) {
					var t,
						r,
						...
						a = {
							...
							id: '',
							items: (0, Oi.getElementsByTagName)(
								'item',
								e.children
							).map(function (e) {
								var t = e.children,
								...
								Mi(r, 'id', 'guid', t),
									Mi(r, 'title', 'title', t),
									Mi(r, 'link', 'link', t),
									Mi(r, 'description', 'description', t);
								var n = ji('pubDate', t);
					...
					Mi(a, 'title', 'title', n),
						Mi(a, 'link', 'link', n),
						Mi(a, 'description', 'description', n);
					var i = ji('lastBuildDate', n);
					i && (a.updated = new Date(i));
					return Mi(a, 'author', 'managingEditor', n, !0), a;
			  })(t)
		: null;
};
var Ni = ['url', 'type', 'lang'],
	Pi = [
		'fileSize',
		'bitrate',
		'framerate',
...
function Ii(e) {
	return (0, Oi.getElementsByTagName)('media:content', e).map(function (e) {
		for (
			var t = e.attribs,
		...
		for (var i = 0, o = Pi; i < o.length; i++) {
			var s;
			t[(s = o[i])] && (r[s] = parseInt(t[s], 10));
		}
		return t.expression && (r.expression = t.expression), r;
	});
}
function Ri(e, t) {
	return (0, Oi.getElementsByTagName)(e, t, !0, 1)[0];
}
function ji(e, t, r) {
	return (
		void 0 === r && (r = !1),
		(0, Bi.textContent)((0, Oi.getElementsByTagName)(e, t, r, 1)).trim()
	);
}
...
Object.defineProperty(ga, '__esModule', { value: !0 }),
	(ga.parseFeed = ga.FeedHandler = void 0);
var zi,
	$i,
	Ji,
	Yi,
	...
	Zi = Gi(ba),
	Qi = dn;
(($i = zi || (zi = {}))[($i.image = 0)] = 'image'),
	($i[($i.audio = 1)] = 'audio'),
	($i[($i.video = 2)] = 'video'),
	($i[($i.document = 3)] = 'document'),
	($i[($i.executable = 4)] = 'executable'),
	((Yi = Ji || (Ji = {}))[(Yi.sample = 0)] = 'sample'),
	(Yi[(Yi.full = 1)] = 'full'),
	(Yi[(Yi.nonstop = 2)] = 'nonstop');
var Ki = (function (e) {
	function t(t, r) {
		return (
			...
			if (r) {
				...
				if ('feed' === r.name) {
					...
					(n.type = 'atom'),
						io(n, 'id', 'id', a),
						io(n, 'title', 'title', a);
					var i = ao('href', ro('link', a));
					i && (n.link = i),
						io(n, 'description', 'subtitle', a),
						(o = no('updated', a)) && (n.updated = new Date(o)),
						io(n, 'author', 'email', a, !0),
						(n.items = to('entry', a).map(function (e) {
							var t = {},
								r = e.children;
							io(t, 'id', 'id', r), io(t, 'title', 'title', r);
							var n = ao('href', ro('link', r));
							n && (t.link = n);
							var a = no('summary', r) || no('content', r);
							a && (t.description = a);
							var i = no('updated', r);
							return (
								i && (t.pubDate = new Date(i)),
								(t.media = eo(r)),
								t
							);
						}));
					...
					(n.type = r.name.substr(0, 3)),
						...
						io(n, 'title', 'title', a),
						io(n, 'link', 'link', a),
						io(n, 'description', 'description', a),
						(o = no('lastBuildDate', a)) &&
							(n.updated = new Date(o)),
						io(n, 'author', 'managingEditor', a, !0),
						(n.items = to('item', r.children).map(function (e) {
							var t = {},
								r = e.children;
							io(t, 'id', 'guid', r),
								io(t, 'title', 'title', r),
								io(t, 'link', 'link', r),
								io(t, 'description', 'description', r);
							var n = no('pubDate', r);
							return (
...
function eo(e) {
	return to('media:content', e).map(function (e) {
...
function to(e, t) {
	return Zi.getElementsByTagName(e, t, !0);
}
function ro(e, t) {
	return Zi.getElementsByTagName(e, t, !0, 1)[0];
}
function no(e, t, r) {
	return (
		void 0 === r && (r = !1),
		Zi.getText(Zi.getElementsByTagName(e, t, r, 1)).trim()
	);
}
function ao(e, t) {
...
(ga.FeedHandler = Ki),
	(ga.parseFeed = function (e, t) {
		void 0 === t && (t = { xmlMode: !0 });
		var r = new Ki(t);
		return new Qi.Parser(r, t).end(e), r.feed;
	}),
	(function (e) {
		var t =
				(H && H.__createBinding) ||
		...
		var u = n(Ct);
		(e.ElementType = u), a(ga, e), (e.DomUtils = n(ba));
		var p = ga;
...
var po = {
	...
	mergeDuplicatesPreferLast: function (e, t) {
		...
		for (let n = e.length; n-- > 0; ) {
			const a = e[n],
				i = t(a);
			r.set(i, r.has(i) ? so(a, r.get(i), { arrayMerge: uo }) : a);
		}
	...
	numberToRoman: function (e) {
		return [...(e + '')]
			...
			.map((e, t) =>
				e % 5 < 4
					? (e < 5 ? '' : co[t]) + lo[t].repeat(e % 5)
					: lo[t] + (e < 5 ? co[t] : lo[t + 1])
			)
			.reverse()
			.join('');
	},
	...
	InlineTextBuilder: class {
		constructor(e, t) {
			(this.lines = []),
				...
				(this.wrapCharacters = e.longWordSplit.wrapCharacters || []),
		...
		splitLongWord(e) {
			...
			for (; e.length > this.maxLineLength; ) {
				const n = e.substring(0, this.maxLineLength),
					...
					i = n.lastIndexOf(this.wrapCharacters[r]);
				if (i > -1)
					(e = n.substring(i + 1) + a), t.push(n.substring(0, i + 1));
				else {
					if ((r++, !(r < this.wrapCharacters.length))) {
						if (this.forceWrapOnLimit) {
							if (
								(t.push(n), (e = a).length > this.maxLineLength)
							)
								continue;
						} else e = n + a;
						break;
...
var go = {
	BlockStackItem: class extends mo {
		constructor(e, t = null, r = 1, n) {
			super(t),
				(this.leadingLineBreaks = r),
				(this.inlineTextBuilder = new ho(e, n)),
				(this.rawText = ''),
	...
	StackItem: mo,
	TableCellStackItem: class extends mo {
		constructor(e, t = null, r) {
			super(t),
				(this.inlineTextBuilder = new ho(e, r)),
				(this.rawText = ''),
				(this.stashedLineBreaks = 0),
				(this.isPre = t && t.isPre);
		}
	},
	TableRowStackItem: class extends mo {
		constructor(e = null) {
			super(e), (this.cells = []), (this.isPre = e && e.isPre);
		}
	},
	TableStackItem: class extends mo {
		constructor(e = null) {
			super(e), (this.rows = []), (this.isPre = e && e.isPre);
		}
	},
	TransformerStackItem: class extends mo {
...
function yo(e, t, r, n) {
	for (let a = 0; a < e.rowspan; a++) {
		const i = bo(t, r + a);
		for (let t = 0; t < e.colspan; t++) i[n + t] = e;
	}
}
function wo(e, t, r, n) {
			...
			for (; t < i && (e = n[c][t]); ) {
				if (!e.rendered) {
					...
					for (let r = 0; r < e.lines.length; r++) {
						const a = e.lines[r],
							i = o[t] + r;
						(s[i] = (s[i] || '').padEnd(l[c]) + a),
							(n = a.length > n ? a.length : n);
					}
					wo(l, c, e.colspan, n + r), (e.rendered = !0);
				}
				t += e.rowspan;
			}
		}
					...
					if (o)
						for (
							...
							'\n' === o[0]
								...
								: r.pushWord(n(o[0]));
					r.stashedSpace =
						(a && !i) || this.testTrailingWhitespace(t);
				};
			} else {
...
const { trimCharacter: So } = po,
	{
		StackItem: Eo,
		BlockStackItem: qo,
		TableCellStackItem: Do,
		TableRowStackItem: To,
		TableStackItem: Ao,
		TransformerStackItem: Lo,
	} = go,
	{ tableToString: Co } = xo,
	{ WhitespaceProcessor: _o } = ko;
function Bo(e) {
	if (!(e instanceof qo || e instanceof Do))
		throw new Error(
...
function Oo(e, t, r, n) {
	...
	const a = Bo(e),
		i = Math.max(e.stashedLineBreaks, r);
	e.inlineTextBuilder.clear(),
		a
			? (e.rawText = a + '\n'.repeat(i) + t)
			: ((e.rawText = t), (e.leadingLineBreaks = i)),
...
var No = {
	BlockTextBuilder: class {
		constructor(e, t) {
			(this.options = e),
				(this.picker = t),
				(this.whitepaceProcessor = new _o(e)),
				(this._stackItem = new qo(e)),
				(this._wordTransformer = void 0);
		}
		pushWordTransform(e) {
			this._wordTransformer = new Lo(this._wordTransformer, e);
		}
		popWordTransform() {
		...
		addLineBreak() {
			(this._stackItem instanceof qo || this._stackItem instanceof Do) &&
			...
			(this._stackItem instanceof qo || this._stackItem instanceof Do) &&
				(this._stackItem.isPre
					...
					: (this.whitepaceProcessor.testContainsWords(e) ||
							(e.length && !this._stackItem.stashedLineBreaks)) &&
		...
		_openBlock({
			...
			(this._stackItem = new qo(this.options, this._stackItem, e, n)),
		...
		openTable() {
			this._stackItem = new Ao(this._stackItem);
		}
		openTableRow() {
			if (!(this._stackItem instanceof Ao))
				throw new Error(
					"Can't add table row to something that is not a table! Check the formatter."
				);
			this._stackItem = new To(this._stackItem);
		}
		openTableCell(e = {}) {
			'object' == typeof e
		...
		_openTableCell({ maxColumnWidth: e } = {}) {
			if (!(this._stackItem instanceof To))
				throw new Error(
					"Can't add table cell to something that is not a table row! Check the formatter."
				);
			this._stackItem = new Do(this.options, this._stackItem, e);
		}
		closeTableCell(e = {}, t) {
			'object' == typeof e
		...
		_closeTable({
			...
			const a = this._popStackItem(),
				i = Co(a.rows, t, e);
			i && Oo(this._stackItem, i, r, n);
		}
		toString() {
			return Bo(this._stackItem.getRoot());
		}
	},
};
const Po = un.exports,
	{
		get: Io,
		numberToLetterSequence: Ro,
		numberToRoman: jo,
		splitClassesAndIds: Mo,
		trimCharacter: Fo,
	} = po;
function Uo(e, t, r, n) {
...
function Vo(e, t, r, n, a) {
	const i = 'li' === Io(e, ['parent', 'name']);
	let o = 0;
	const s = (e.children || [])
		.filter((e) => 'text' !== e.type || !/^\s*$/.test(e.data))
		.map(function (e) {
			if ('li' !== e.name) return { node: e, prefix: '' };
			const t = i ? a().trimStart() : a();
			return t.length > o && (o = t.length), { node: e, prefix: t };
		});
	if (!s.length) return;
	const l = o,
		c = '\n' + ' '.repeat(l);
	r.openBlock({ leadingLineBreaks: i ? 1 : n.leadingLineBreaks || 2 });
	...
	r.closeBlock({ trailingLineBreaks: i ? 1 : n.trailingLineBreaks || 2 });
}
function Ho(e, t, r, n) {
	function a(e) {
		const a = +Io(e, ['attribs', 'colspan']) || 1,
			i = +Io(e, ['attribs', 'rowspan']) || 1;
		r.openTableCell({ maxColumnWidth: n.maxColumnWidth }),
			t(e.children, r),
			r.closeTableCell({ colspan: a, rowspan: i });
	}
	r.openTable(),
...
var Go = {
		...
		const a = (function () {
			...
			return n.noAnchorUrl && '#' === t[0]
				...
				: ((t = n.baseUrl && '/' === t[0] ? n.baseUrl + t : t),
				  Po.decode(t, r.options.decodeOptions));
		})();
		if (a) {
			let i = '';
			r.pushWordTransform((e) => (e && (i += e), e)),
				t(e.children, r),
				r.popWordTransform();
			(n.hideLinkHrefIfSameAsText && a === i) ||
				r.addInline(
					i ? (n.noLinkBrackets ? ' ' + a : ' [' + a + ']') : a,
					{ noWordTransform: !0 }
				);
		} else t(e.children, r);
	},
	...
	image: function (e, t, r, n) {
		const a = e.attribs || {},
			i = a.alt ? Po.decode(a.alt, r.options.decodeOptions) : '',
			o = a.src
	...
	table: function (e, t, r, n) {
		return (function (e, t) {
			if (!0 === t) return !0;
			if (!e) return !1;
			const { classes: r, ids: n } = Mo(t),
				a = (e.class || '').split(' '),
				i = (e.id || '').split(' ');
			return a.some((e) => r.includes(e)) || i.some((e) => n.includes(e));
...
const { hp2Builder: Wo } = At,
	zo = cn,
	$o = un.exports,
	Jo = pn,
	Yo = rr,
	{ BlockTextBuilder: Xo } = No,
	Zo = Go,
	{ limitedDepthRecursive: Qo, mergeDuplicatesPreferLast: Ko, set: es } = po,
	ts = {
		baseElements: {
			selectors: ['body'],
			orderBy: 'selectors',
...
function as(e = {}) {
	((e = zo(ts, e, {
		arrayMerge: rs,
		customMerge: (e) => ('selectors' === e ? ns : void 0),
	})).formatters = Object.assign({}, Zo, e.formatters)),
		(function (e) {
			const t = e.selectors;
			if (e.tags) {
			...
			if (
				...
				for (const n of t) 'image' === n.format && (n.format = 'skip');
			if (e.singleNewLineParagraphs)
				for (const n of t)
					('paragraph' !== n.format && 'pre' !== n.format) ||
						(es(n, ['options', 'leadingLineBreaks'], 1),
						es(n, ['options', 'trailingLineBreaks'], 1));
			if (e.baseElement) {
	...
	const t = Ko(e.selectors, (e) => e.selector),
	...
	const n = new Yo.DecisionTree(t.map((e) => [e.selector, e])).build(Wo),
		a = new Yo.DecisionTree(
	...
	function i(t) {
		return (function (e, t, r) {
			...
			function a(e, a) {
				...
				for (const i of a) {
					if ('tag' !== i.type) continue;
					const a = r.pick1(i);
					if (
						(a > 0
							? n.push({ selectorIndex: a, element: i })
	...
	const o = Qo(e.limits.maxDepth, os, function (t, r) {
		r.addInline(e.limits.ellipsis || '');
	});
	return function (t) {
		return (function (e, t, r, n, a) {
			const i = t.limits.maxInputLength;
			i &&
				e &&
				e.length > i &&
				(console.warn(
					`Input length ${e.length} is above allowed limit of ${i}. Truncating without ellipsis.`
				),
				(e = e.substring(0, i)));
			const o = new Jo.DomHandler();
			new Jo.Parser(o, { decodeEntities: !1 }).parseComplete(e);
			const s = n(o.dom),
				l = new Xo(t, r);
...
function os(e, t, r) {
	...
	for (const a of t)
		switch (a.type) {
			case 'text':
				r.addInline($o.decode(a.data, n.decodeOptions));
				break;
			case 'tag': {
...
!(function (e, t) {
	var r,
		...
		S = parseInt,
		E = 'object' == typeof H && H && H.Object === Object && H,
		q = 'object' == typeof self && self && self.Object === Object && self,
		D = E || q || Function('return this')(),
		T = t && !t.nodeType && t,
		A = T && e && !e.nodeType && e,
		L = A && A.exports === T && E.process,
		C = (function () {
			try {
	...
	var G,
		W = _
			...
			: function (e) {
					return V(e) && '[object RegExp]' == I.call(e);
			  };
	function z(e) {
		return (
			'symbol' == typeof e ||
		...
		if (V(t)) {
			...
			(r =
				'length' in t
					...
					: r),
				(n = 'omission' in t ? F(t.omission) : n);
		}
		var i = (e = J(e)).length;
		if (O(e)) {
			var s = P(e);
		...
		if ((s && (l += c.length - l), W(a))) {
			if (e.slice(l).search(a)) {
				var u,
					p = c;
				for (
					a.global || (a = RegExp(a.source, J(o.exec(a)) + 'g')),
						a.lastIndex = 0;
					(u = a.exec(p));
...
function us(e, t) {
	...
	var o = v(function (t) {
		...
		s = v(function (t) {
			t.storageArea === localStorage && t.key === e && a(t.newValue);
		}, []),
		l = v(
			function () {
				if ((o(null), 'undefined' == typeof localStorage)) return !1;
	...
	return (
		...
		Object.assign([n, o, l], { value: n, remove: l, set: o })
	);
}
...
var hs = {}[0],
	...
	ys = !0,
	xs = 'undefined' != typeof window,
	ks = 'undefined' != typeof document,
	Ss = (xs && window.addEventListener) || bs,
	Es = (ks && document.addEventListener) || bs,
	qs = {
		isOnline: function () {
			return ys;
		},
		isVisible: function () {
			var e = ks && document.visibilityState;
			return !!ms(e) || 'hidden' !== e;
		},
	},
	Ds = {
		initFocus: function (e) {
			Es('visibilitychange', e), Ss('focus', e);
		},
	...
	Ts = 'undefined' == typeof window || 'Deno' in window,
	As = Ts ? null : window.requestAnimationFrame,
	Ls = As
		? function (e) {
				return As(e);
		  }
	...
	Cs = Ts ? g : m,
	_s = 'undefined' != typeof navigator && navigator.connection,
	Bs =
		!Ts &&
		_s &&
		(['slow-2g', '2g'].includes(_s.effectiveType) || _s.saveData),
	Os = new WeakMap(),
	Ns = 0;
function Ps(e) {
	if (gs(e))
	...
	Fs = function (e, t, r, n) {
		return (
			...
			ds(void 0, void 0, void 0, function () {
				var a, i, o, s, l, c, u, p, d, f, h;
				return fs(this, function (m) {
					switch (m.label) {
						case 0:
							if (((a = Ps(t)), (i = a[0]), (o = a[2]), !i))
								return [2];
							if (
								((s = Is.get(e)), (l = s[2]), (c = s[3]), ms(r))
							)
								return [2, Rs(e, i, e.get(i), e.get(o), hs, n)];
							if (((d = l[i] = Ms()), (c[i] = 0), gs(r)))
								try {
									r = r(e.get(i));
								} catch (g) {
									(r = hs), (p = g);
								}
							if (!r || !gs(r.then)) return [3, 5];
							m.label = 1;
						case 1:
...
function Vs(e, t) {
	if (!Is.has(e)) {
		...
		return (
			Is.set(e, [n, {}, {}, {}, {}, {}, a]),
			Ts ||
				(r.initFocus(Us.bind(hs, n, 0)),
				r.initReconnect(Us.bind(hs, n, 1))),
			[e, a]
		);
	}
}
	...
	zs = vs(
		{
			...
			errorRetryInterval: Bs ? 1e4 : 5e3,
			focusThrottleInterval: 5e3,
			dedupingInterval: 2e3,
			loadingTimeout: Bs ? 5e3 : 3e3,
...
function $s(e, t) {
	...
	var n = e.use,
		...
		o = t.fallback;
	return (
		n && i && (r.use = n.concat(i)), a && o && (r.fallback = vs(a, o)), r
	);
}
var Js = x({});
function Ys(e) {
...
Object.defineProperty(
	function (e) {
		var t = e.children,
			...
			a = r && r.provider,
			i = b(function () {
				return a ? Vs(a(n.cache || Gs), r) : hs;
			})[0];
		return (
			i && ((n.cache = i[0]), (n.mutate = i[1])),
			f(Js.Provider, { value: n }, t)
		);
	},
	'default',
	{ value: zs }
...
var Ks =
	((Xs = function (e, t, r) {
		var n = r.cache,
			...
			l = r.refreshInterval,
			c = r.refreshWhenHidden,
			u = r.refreshWhenOffline,
			p = Is.get(n),
			d = p[0],
			f = p[1],
			h = p[2],
		...
		var I,
			...
			V = function () {
				return ms(s)
					? o
						? !T.current && !ms(N)
						: ms(N) || r.revalidateIfStale
					: s;
			},
			H = !(!k || !t) && (!!n.get(D) || (!T.current && V())),
			G =
				((I = { data: N, error: P, isValidating: H }),
				(R = A),
				(j = b({})[1]),
				(M = y(I)),
				(F = y({ data: !1, error: !1, isValidating: !1 })),
				(U = v(function (e) {
					var t = !1,
						r = M.current;
					for (var n in e) {
			...
			J = v(
				function (e) {
					return ds(void 0, void 0, void 0, function () {
						var i, o, s, l, c, u, p, d, f;
						return fs(this, function (b) {
							switch (b.label) {
								case 0:
									if (!k || !t || A.current || _().isPaused())
										return [2, !1];
									(s = !0),
										(l = e || {}),
										(c = !ms(g[k]) && l.dedupe),
										...
										: (n.set(q, hs),
										  ...
										  (o <= h[k] || o <= m[k] || 0 === m[k])
												...
												: (ms(W.current.error) ||
												  ...
												  a(W.current.data, i) ||
														(d.data = i),
												  a(n.get(k), i) || n.set(k, i),
												  $(d),
												  c || Rs(n, k, i, d.error, !1),
												  [3, 7]));
								case 6:
									return (
										(f = b.sent()),
							...
							o = Zs(k, d, function (e) {
								if (0 === e) {
									...
									_().revalidateOnFocus &&
										a > n &&
										r() &&
										((n = a + _().focusThrottleInterval),
										t());
								} else if (1 === e)
									_().revalidateOnReconnect && r() && t();
								else if (2 === e) return J();
							});
						return (
							(A.current = !1),
							(L.current = k),
							e && $({ data: N, error: P, isValidating: H }),
							V() && (ms(N) || Ts ? t() : Ls(t)),
							(T.current = !0),
							function () {
								(A.current = !0), i(), o();
	...
	function () {
		...
		var r = Ys(e),
			...
			l = Xs,
			c = s.use;
		if (c) for (var u = c.length; u-- > 0; ) l = c[u](l);
		return l(n, a || s.fetcher, s);
	});
...
function tl(e) {
	...
	return c.createElement(
		...
		t
			? t.map((t) => {
					const r = ss.htmlToText(t.content);
					return c.createElement(
						'a',
						{
							className:
							...
							(function (e, t) {
								...
								if (p < 2)
									return r.includeSeconds
										...
										: n.formatDistance('xMinutes', p, s);
								if (p < 45)
									return n.formatDistance('xMinutes', p, s);
								if (p < 90)
								...
								if (p < 43200) {
									var f = Math.round(p / 1440);
									return n.formatDistance('xDays', f, s);
								}
								if (p < 86400)
									return (
										(l = Math.round(p / 43200)),
										n.formatDistance('aboutXMonths', l, s)
									);
								if ((l = ut(o, i)) < 12) {
									var h = Math.round(p / 43200);
									return n.formatDistance('xMonths', h, s);
								}
								var m = l % 12,
									g = Math.floor(l / 12);
								return m < 3
			...
			: c.createElement('span', null, 'Error!')
	);
}
function rl(e) {
	const { feed: t, isLoading: r } = (function (e, t) {
			const { data: r, error: n } = Ks(`${e}/api/feed?userId=${t}`, el);
			return { feed: null == r ? void 0 : r.feed, isLoading: !n && !r };
		})(null == e ? void 0 : e.baseUrl, null == e ? void 0 : e.userId),
		{ value: n, set: a } = us('heraldLatestUpdate'),
		[i, o] = b(!1);
	return (
		g(() => {
			t && t[0].published_at !== n && (a(t[0].published_at), o(!0));
		}, [t]),
		c.createElement(Ae, { className: 'relative' }, ({ open: n }) =>
			c.createElement(
				c.Fragment,
				null,
				c.createElement(
